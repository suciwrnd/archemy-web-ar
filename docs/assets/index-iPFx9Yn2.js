...
void main() {
  ...
  `,e.querySelector(`#hookContinue`).addEventListener(`click`,()=>{Yd.whoosh(),n()})}function Sf(e,t,n=[],r){let i=window.state?.viewedMisi||[],a=Tu(),o={H2I2:`misi1`,NO2_N2O4:`misi2`,FeSCN:`misi3`,AceticAcid:`misi4`},s=a.map(e=>{let t=o[e.id]||e.id,r=i.includes(t)||i.includes(e.id),a=n.includes(t)||n.includes(e.id),s=e.accentColor?`#${e.accentColor.toString(16).padStart(6,`0`)}`:`#4fc3f7`;return`
  ...
  `,e.querySelectorAll(`.me-misi-card`).forEach(e=>{e.addEventListener(`click`,()=>t(e.dataset.misi))}),r){let t=e.querySelector(`#btnBackPilih`);t&&t.addEventListener(`click`,r)}}async function Cf(e,t,n){let r=wu(Du(t));if(!r)return;yf(),e.innerHTML=`
...
`+e.stack)}let u=!1,d=e=>{if(e?.preventDefault&&e.preventDefault(),!u){if(!l){alert(`Sesi belum siap atau gagal dimuat.`);return}u=!0,l&&l.startSession();try{document.documentElement.requestFullscreen&&document.documentElement.requestFullscreen().catch(()=>{})}catch{}o.style.opacity=`0`,o.style.pointerEvents=`none`,setTimeout(()=>{o.style.display=`none`},500)}},f=e.querySelector(`#btnMasuk`);f&&(f.addEventListener(`click`,d),f.addEventListener(`touchstart`,d,{passive:!1}))}function wf(){bf&&=(bf.hentikan?.(),null)}var Tf={bell:`<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 22a2.7 2.7 0 0 0 2.65-2.15h-5.3A2.7 2.7 0 0 0 12 22Zm7-6.4-1.45-1.95V9.2A5.56 5.56 0 0 0 13 3.75V2h-2v1.75A5.56 5.56 0 0 0 6.45 9.2v4.45L5 15.6V18h14v-2.4Z"/></svg>`,user:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><circle cx="12" cy="8" r="4"/><path d="M4 21c1.7-4.2 5-6 8-6s6.3 1.8 8 6"/></svg>`,home:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M3 11.5 12 4l9 7.5"/><path d="M5.5 10.5V21h13V10.5"/><path d="M9.3 21v-6h5.4v6"/></svg>`,checklist:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><rect x="4" y="3.8" width="16" height="16.4" rx="2"/><path d="m8 8 1.5 1.5L12 7"/><path d="M14 8.5h2.5"/><path d="m8 14 1.5 1.5L12 13"/><path d="M14 14.5h2.5"/></svg>`,ar:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M8 3H5a2 2 0 0 0-2 2v3"/><path d="M16 3h3a2 2 0 0 1 2 2v3"/><path d="M8 21H5a2 2 0 0 1-2-2v-3"/><path d="M16 21h3a2 2 0 0 0 2-2v-3"/><circle cx="12" cy="12" r="3"/><path d="M12 9V6m0 12v-3m3-3h3m-12 0h3"/></svg>`,book:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M4 5.5A3.5 3.5 0 0 1 7.5 2H20v17H7.5A3.5 3.5 0 0 0 4 22V5.5Z"/><path d="M4 19.5A3.5 3.5 0 0 1 7.5 16H20"/></svg>`,file:`<svg viewBox="0 0 24 24" fill="currentColor"><path d="M6 2h8.2L20 7.8V22H6V2Zm8 1.7V8h4.3L14 3.7Z"/></svg>`,play:`<svg viewBox="0 0 24 24" fill="currentColor"><path d="M5 4.8A2.8 2.8 0 0 1 7.8 2h8.4A2.8 2.8 0 0 1 19 4.8v14.4a2.8 2.8 0 0 1-2.8 2.8H7.8A2.8 2.8 0 0 1 5 19.2V4.8Zm5 4v6.4l5.4-3.2L10 8.8Z"/></svg>`,link:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M10 13.5a4 4 0 0 0 5.6.4l2.3-2.3a4 4 0 1 0-5.7-5.7l-1.3 1.3"/><path d="M14 10.5a4 4 0 0 0-5.6-.4l-2.3 2.3a4 4 0 0 0 5.7 5.7l1.3-1.3"/></svg>`,people:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><circle cx="9" cy="8" r="3"/><path d="M3 19c1.1-3.2 3.4-5 6-5s4.9 1.8 6 5"/><circle cx="17" cy="9" r="2.3"/><path d="M15.5 14.7c2.4.2 4.2 1.7 5.2 4.3"/></svg>`,plus:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M12 5v14M5 12h14"/></svg>`,trash:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M4 7h16M9 7V4h6v3M7 7l1 14h8l1-14"/></svg>`,edit:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M4 20h4l10.5-10.5a2.1 2.1 0 0 0-3-3L5 17v3Z"/><path d="m14 8 2 2"/></svg>`,logout:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M10 4H5v16h5"/><path d="M14 8l4 4-4 4"/><path d="M8 12h10"/></svg>`,brain:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M9 4a3 3 0 0 0-3 3 3 3 0 0 0-1 5.7A3.5 3.5 0 0 0 8.5 18H9V4Z"/><path d="M15 4a3 3 0 0 1 3 3 3 3 0 0 1 1 5.7A3.5 3.5 0 0 1 15.5 18H15V4Z"/><path d="M9 8c-1.4 0-2.5.8-3 2M15 8c1.4 0 2.5.8 3 2M9 14c-1.2.2-2 .9-2.5 2M15 14c1.2.2 2 .9 2.5 2"/></svg>`,star:`<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2l2.9 6.1 6.6.9-4.8 4.7 1.1 6.6L12 17.3l-5.8 3 1.1-6.6L2.5 9l6.6-.9z"/></svg>`,gem:`<svg viewBox="0 0 24 24" fill="currentColor"><path d="M6.5 2h11l4.5 6-10 14L2 8zm.5 2L4 8h4.5l2-4zm5 0 2 4H14l-1.5-4zm6.5 2h-2.5l-2-4H16zM5.5 10l4.5 9.5L5 10zm6.5 9.5L16.5 10H8zm5-9.5h-4.5l4.5 9.5z"/></svg>`,trophy:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M8 21h8M12 17v4"/><path d="M5 3H3v5a4 4 0 0 0 4 4h1"/><path d="M19 3h2v5a4 4 0 0 1-4 4h-1"/><rect x="6" y="3" width="12" height="11" rx="1"/></svg>`,map:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="m3 7 6-3 6 3 6-3v13l-6 3-6-3-6 3V7z"/><path d="M9 4v13M15 7v13"/></svg>`,chart:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M3 3v18h18"/><path d="m7 11 4-4 4 4 4-4"/></svg>`,check:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M20 6 9 17l-5-5"/></svg>`},Ef=[{id:`qs1`,topic:`Konsep Dasar Kesetimbangan`,bloomLevel:1,bloomLabel:`C1 - Mengingat`,tier1:{question:`Suatu reaksi dikatakan berada dalam keadaan setimbang apabila...`,options:[`Reaksi telah berhenti sepenuhnya dan tidak ada perubahan`,`Laju reaksi maju sama dengan laju reaksi balik`,`Semua reaktan telah habis bereaksi membentuk produk`,`Konsentrasi reaktan selalu lebih besar dari konsentrasi produk`],answer:1},tier3:{question:`Alasan ilmiah yang mendukung jawaban Anda adalah...`,options:[`Pada keadaan setimbang, laju pembentukan produk sama dengan laju penguraian produk kembali menjadi reaktan, sehingga konsentrasi tampak tetap`,`Kesetimbangan tercapai karena semua molekul berhenti bergerak`,`Kesetimbangan hanya terjadi jika suhu dan tekanan sistem adalah nol`,`Pada kesetimbangan, energi kinetik semua partikel menjadi sama besar`],answer:0}},{id:`qs2`,topic:`Kesetimbangan Dinamis`,bloomLevel:2,bloomLabel:`C2 - Memahami`,tier1:{question:`Pada kesetimbangan dinamis, pernyataan yang paling tepat adalah...`,options:[`Reaksi maju dan balik sudah berhenti sama sekali`,`Konsentrasi reaktan dan produk terus berubah secara drastis`,`Reaksi maju dan balik tetap berlangsung dengan laju yang sama sehingga komposisi campuran tetap`,`Hanya reaksi ke arah produk yang masih berlangsung`],answer:2},tier3:{question:`Dasar ilmiah yang menjelaskan kesetimbangan dinamis adalah...`,options:[`On a molecular level, collisions between particles still occur and forward-reverse reactions proceed simultaneously, but the net change in concentration is zero`,`Molekul berhenti bergerak begitu sistem mencapai kesetimbangan`,`Energi kinetik rata-rata semua molekul menjadi nol pada keadaan setimbang`,`Kesetimbangan dinamis hanya dapat terjadi pada tekanan sangat tinggi`],answer:0}},{id:`qs3`,topic:`Pengaruh Konsentrasi`,bloomLevel:3,bloomLabel:`C3 - Mengaplikasikan`,tier1:{question:`Pada reaksi: N₂(g) + 3H₂(g) ⇌ 2NH₃(g), jika konsentrasi N₂ ditambah, kesetimbangan akan...`,options:[`Bergeser ke kiri (arah reaktan)`,`Bergeser ke kanan (arah produk)`,`Tidak mengalami pergeseran`,`Reaksi langsung berhenti`],answer:1},tier3:{question:`Alasan ilmiah dari pergeseran kesetimbangan tersebut adalah...`,options:[`Sesuai Asas Le Chatelier, penambahan konsentrasi reaktan mendorong sistem bergeser ke arah produk untuk mengurangi gangguan`,`Penambahan N₂ menurunkan energi aktivasi reaksi maju saja`,`Gas N₂ yang ditambahkan langsung terurai menjadi atom nitrogen bebas`,`Konsentrasi reaktan tidak pernah mempengaruhi posisi kesetimbangan`],answer:0}},{id:`qs4`,topic:`Pengaruh Tekanan dan Volume`,bloomLevel:3,bloomLabel:`C3 - Mengaplikasikan`,tier1:{question:`Pada reaksi: 2SO₂(g) + O₂(g) ⇌ 2SO₃(g), jika tekanan dinaikkan, kesetimbangan akan...`,options:[`Bergeser ke kiri karena mol gas reaktan lebih sedikit`,`Bergeser ke kanan karena mol gas produk lebih sedikit`,`Tidak berubah karena tekanan tidak mempengaruhi kesetimbangan gas`,`Bergeser ke kiri karena SO₃ lebih berat dari SO₂`],answer:1},tier3:{question:`Prinsip yang mendasari pengaruh tekanan ini adalah...`,options:[`Peningkatan tekanan menggeser sistem ke sisi dengan jumlah mol gas lebih sedikit (3 mol → 2 mol) sesuai Asas Le Chatelier`,`Tekanan tinggi selalu menguntungkan produk pada semua reaksi`,`Tekanan hanya mempengaruhi reaksi fase cair`,`Peningkatan tekanan selalu menghentikan reaksi kesetimbangan`],answer:0}},{id:`qs5`,topic:`Pengaruh Suhu`,bloomLevel:3,bloomLabel:`C3 - Mengaplikasikan`,tier1:{question:`Reaksi: N₂O₄(g) ⇌ 2NO₂(g), ΔH = +57 kJ/mol. Jika suhu dinaikkan, kesetimbangan akan...`,options:[`Bergeser ke kiri sehingga N₂O₄ bertambah`,`Bergeser ke kanan sehingga NO₂ bertambah`,`Tidak mengalami pergeseran`,`Reaksi berubah menjadi ireversibel`],answer:1},tier3:{question:`Dasar ilmiah pengaruh suhu pada kesetimbangan ini adalah...`,options:[`Kenaikan suhu menyediakan kalor yang dimanfaatkan reaksi endoterm (ke kanan) untuk menyerap kelebihan kalor sesuai Asas Le Chatelier`,`Suhu tinggi selalu mempercepat semua reaksi ke arah produk`,`Perubahan suhu hanya mempengaruhi laju reaksi, tidak mengubah tetapan kesetimbangan`,`Kenaikan suhu menurunkan energi aktivasi reaksi balik saja`],answer:0}},{id:`qs6`,topic:`Peran Katalis`,bloomLevel:2,bloomLabel:`C2 - Memahami`,tier1:{question:`Penambahan katalis pada sistem kesetimbangan akan...`,options:[`Menggeser kesetimbangan ke arah produk`,`Menggeser kesetimbangan ke arah reaktan`,`Mempercepat tercapainya kesetimbangan tanpa mengubah posisi kesetimbangan`,`Menghentikan reaksi balik sepenuhnya`],answer:2},tier3:{question:`Alasan katalis tidak mengubah posisi kesetimbangan adalah...`,options:[`Katalis menurunkan energi aktivasi reaksi maju dan balik secara proporsional sama, sehingga perbandingan laju tidak berubah`,`Katalis hanya mempengaruhi warna larutan`,`Katalis menambah jumlah mol produk melalui reaksi samping`,`Katalis menyerap seluruh energi kinetik molekul gas`],answer:0}},{id:`qs7`,topic:`Tetapan Kesetimbangan Kc`,bloomLevel:4,bloomLabel:`C4 - Menganalisis`,tier1:{question:`Untuk reaksi: 2A(g) + B(g) ⇌ 3C(g), ekspresi Kc yang benar adalah...`,options:[`Kc = [A]²[B] / [C]³`,`Kc = [C]³ / ([A]²[B])`,`Kc = [C] / ([A][B])`,`Kc = ([A] + [B]) / [C]`],answer:1},tier3:{question:`Prinsip penulisan ekspresi Kc tersebut didasarkan pada...`,options:[`Kc merupakan perbandingan konsentrasi produk berpangkat koefisien dibagi konsentrasi reaktan berpangkat koefisien`,`Nilai Kc selalu sama dengan 1`,`Koefisien reaksi tidak mempengaruhi ekspresi Kc`,`Kc dihitung dari penjumlahan konsentrasi semua zat`],answer:0}},{id:`qs8`,topic:`Hubungan Kp dan Kc`,bloomLevel:4,bloomLabel:`C4 - Menganalisis`,tier1:{question:`Hubungan antara Kp and Kc dinyatakan oleh rumus...`,options:[`Kp = Kc × (RT)^Δn`,`Kp = Kc / (RT)`,`Kp = Kc + RT`,`Kp = Kc × R`],answer:0},tier3:{question:`Makna Δn dalam hubungan Kp = Kc(RT)^Δn adalah...`,options:[`Selisih jumlah koefisien mol gas produk dikurangi koefisien mol gas reaktan`,`Jumlah total mol semua zat`,`Jumlah mol reaktan saja`,`Δn selalu bernilai positif untuk setiap reaksi`],answer:0}},{id:`qs9`,topic:`Kesetimbangan Heterogen`,bloomLevel:4,bloomLabel:`C4 - Menganalisis`,tier1:{question:`Pada reaksi: CaCO₃(s) ⇌ CaO(s) + CO₂(g), ekspresi Kc yang benar adalah...`,options:[`Kc = [CaO][CO₂] / [CaCO₃]`,`Kc = [CO₂]`,`Kc = 1 / [CO₂]`,`Kc = [CaCO₃] / ([CaO][CO₂])`],answer:1},tier3:{question:`Alasan ilmiah zat padat tidak dimasukkan ke ekspresi Kc adalah...`,options:[`Konsentrasi zat padat murni bersifat konstan dan sudah termasuk dalam nilai Kc`,`Zat padat tidak ikut bereaksi`,`Zat padat selalu habis bereaksi`,`Zat padat tidak memiliki massa molar`],answer:0}},{id:`qs10`,topic:`Aplikasi Industri (Proses Haber)`,bloomLevel:5,bloomLabel:`C5 - Mengevaluasi`,tier1:{question:`Dalam proses Haber: N₂(g) + 3H₂(g) ⇌ 2NH₃(g), ΔH = −92 kJ/mol. Kondisi yang menguntungkan pembentukan NH₃ adalah...`,options:[`Suhu tinggi dan tekanan rendah`,`Suhu rendah dan tekanan tinggi`,`Suhu tinggi dan tekanan tinggi`,`Suhu rendah dan tekanan rendah`],answer:1},tier3:{question:`Namun dalam praktik industri digunakan suhu sedang (~450°C) karena...`,options:[`Suhu rendah menguntungkan kesetimbangan namun laju reaksi sangat lambat; suhu sedang dengan katalis besi dipilih sebagai kompromi`,`Suhu rendah merusak peralatan pabrik`,`Suhu tinggi diperlukan agar katalis tidak teroksidasi`,`Pada suhu rendah gas nitrogen membeku`],answer:0}}],Df={"Konsep Dasar Kesetimbangan":{moduleId:`m1`,misiId:null,reason:`Pelajari pengantar kesetimbangan kimia terlebih dahulu.`},"Kesetimbangan Dinamis":{moduleId:`m2`,misiId:`misi1`,reason:`Visualisasikan kesetimbangan dinamis di Lab AR.`},"Pengaruh Konsentrasi":{moduleId:`m6`,misiId:`misi3`,reason:`Misi ini akan memperlihatkan bagaimana konsentrasi mempengaruhi reaksi.`},"Pengaruh Tekanan dan Volume":{moduleId:`m7`,misiId:`misi2`,reason:`Misi Operasi Smog akan menunjukkan pergeseran karena tekanan.`},"Pengaruh Suhu":{moduleId:`m6`,misiId:`misi1`,reason:`Misi Gas Iodin akan memperlihatkan efek perubahan suhu secara visual.`},"Peran Katalis":{moduleId:`m7`,misiId:null,reason:`Baca modul Mekanika Tekanan-Volume & Peran Katalisator.`},"Tetapan Kesetimbangan Kc":{moduleId:`m8`,misiId:null,reason:`Bank soal Kc/Qc akan membantu memahami ekspresi kesetimbangan.`},"Hubungan Kp dan Kc":{moduleId:`m8`,misiId:null,reason:`Pahami hubungan Kp dan Kc melalui contoh soal.`},"Kesetimbangan Heterogen":{moduleId:`m1`,misiId:null,reason:`Baca ulang modul pengantar mengenai zat padat dalam kesetimbangan.`},"Aplikasi Industri (Proses Haber)":{moduleId:`m5`,misiId:`misi4`,reason:`Misi Industri akan mensimulasikan kondisi optimal proses Haber.`}},Of=[{id:`m1`,type:`file`,title:`Pengantar Kesetimbangan Kimia`,meta:`Dokumen • 18 halaman`,summary:`Materi ini menjelaskan konsep reaksi bolak-balik, keadaan setimbang, serta ciri sistem ketika laju reaksi maju dan balik sudah sama.`,points:[`Kesetimbangan bersifat dinamis.`,`Konsentrasi zat tampak tetap pada keadaan setimbang.`,`Sistem tertutup membantu reaksi mencapai setimbang.`],tips:[`Fokus pada perbedaan reaksi satu arah dan reaksi reversibel.`,`Gunakan tabel ICE untuk memahami perubahan konsentrasi.`],difficulty:`Rendah`,time:`10 Menit`,prereq:`Reaksi Kimia Dasar`},{id:`m2`,type:`file`,title:`Kesetimbangan Kimia Dinamis`,meta:`Dokumen • 22 halaman`,summary:`Membahas keadaan saat reaksi tetap berlangsung dua arah, tetapi perubahan makroskopis tidak terlihat karena laju reaksi maju sama dengan laju reaksi balik.`,points:[`Laju maju = laju balik.`,`Jumlah partikel dapat tetap walaupun reaksi tetap terjadi.`,`Kesetimbangan hanya terjadi pada sistem tertutup.`],tips:[`Bayangkan dua arah reaksi berjalan bersamaan.`,`Perhatikan tanda panah bolak-balik pada persamaan reaksi.`],difficulty:`Sedang`,time:`12 Menit`,prereq:`Konsep Reaksi Reversibel`},{id:`m3`,type:`video`,title:`Rahasia Partikel Tak Terlihat: Apa Itu Kesetimbangan Dinamis?`,meta:`Video • 15 menit`,summary:`Video memperlihatkan ilustrasi partikel yang terus bergerak dalam reaksi bolak-balik.`,points:[`Partikel tetap bergerak.`,`Reaksi maju dan balik terjadi bersamaan.`,`Perubahan terlihat stabil secara makroskopis.`],tips:[`Pause pada bagian animasi partikel.`,`Catat contoh reaksi yang digunakan dalam video.`],difficulty:`Sedang`,time:`15 Menit`,prereq:`Kesetimbangan Dinamis`},{id:`m4`,type:`file`,title:`Asas Le Chatelier`,meta:`Dokumen • 25 halaman`,summary:`Sistem kesetimbangan akan bergeser untuk mengurangi pengaruh perubahan yang diberikan.`,points:[`Konsentrasi naik → bergeser menjauhi zat yang ditambah.`,`Tekanan naik → bergeser ke sisi mol gas lebih kecil.`,`Suhu naik → bergeser ke arah reaksi endoterm.`,`Katalis tidak menggeser kesetimbangan.`],tips:[`Ingat konsep "melawan perubahan".`,`Bedakan pengaruh suhu, tekanan, volume, dan katalis.`,`Gunakan simulasi WebAR untuk melihat pergeseran.`],difficulty:`Tinggi`,time:`12 Menit`,prereq:`Kesetimbangan Kimia Dasar`},{id:`m5`,type:`video`,title:`Trik Asas Le Chatelier: Cara Pabrik Kimia Memaksa Reaksi Terus Berjalan`,meta:`Video • 15 menit`,summary:`Video menjelaskan bagaimana industri memanfaatkan Asas Le Chatelier.`,points:[`Tekanan dapat memengaruhi jumlah produk gas.`,`Suhu dipilih berdasarkan jenis reaksi.`,`Konsentrasi reaktan dapat diatur untuk mendorong produk.`],tips:[`Hubungkan materi dengan proses Haber.`,`Perhatikan contoh perubahan tekanan dan suhu.`],difficulty:`Rendah`,time:`17 Menit`,prereq:`Asas Le Chatelier`},{id:`m6`,type:`file`,title:`Pengaruh Parameter Suhu (Termal) & Konsentrasi Le Chatelier`,meta:`Dokumen • 20 halaman`,summary:`Materi ini membahas cara suhu dan konsentrasi mengubah arah pergeseran kesetimbangan.`,points:[`Penambahan reaktan mendorong pembentukan produk.`,`Suhu tinggi menguntungkan arah endoterm.`,`Suhu rendah menguntungkan arah eksoterm.`],tips:[`Tentukan dulu reaksi eksoterm atau endoterm.`,`Perhatikan sisi mana yang menerima penambahan zat.`],difficulty:`Tinggi`,time:`16 Menit`,prereq:`Asas Le Chatelier`},{id:`m7`,type:`file`,title:`Mekanika Tekanan-Volume & Peran Katalisator`,meta:`Dokumen • 19 halaman`,summary:`Materi membahas bagaimana perubahan tekanan dan volume mempengaruhi kesetimbangan gas serta peran katalis.`,points:[`Tekanan naik → ke arah mol gas lebih sedikit.`,`Volume naik → ke arah mol gas lebih banyak.`,`Katalis mempercepat, bukan menggeser.`],tips:[`Hitung jumlah mol gas di tiap sisi.`,`Ingat katalis menurunkan Ea maju dan balik sama besar.`],difficulty:`Sedang`,time:`14 Menit`,prereq:`Asas Le Chatelier`},{id:`m8`,type:`link`,title:`Bank Contoh Soal Kc dan Qc`,meta:`Link • Latihan soal`,summary:`Kumpulan contoh soal untuk membedakan nilai Kc dan Qc.`,points:[`Kc menunjukkan keadaan setimbang.`,`Qc digunakan untuk melihat arah reaksi.`,`Jika Qc < Kc, reaksi bergeser ke produk.`],tips:[`Tuliskan rumus Kc sesuai koefisien.`,`Bandingkan Qc dan Kc secara perlahan.`],difficulty:`Tinggi`,time:`18 Menit`,prereq:`Rumus Tetapan Kesetimbangan`}],kf=[{id:`c1`,name:`XII IPA 1`,code:`KIM-137`,students:36,progress:74,quiz:8,roster:[{name:`Adi Wijaya`,score:40,status:`Kritis`,category:`Miskonsepsi`,topics:[`Pengaruh Tekanan dan Volume`,`Pengaruh Suhu`]},{name:`Syela Cantika`,score:55,status:`Perhatian`,category:`Menebak`,topics:[`Tetapan Kesetimbangan Kc`]},{name:`Fajar Mahendra`,score:88,status:`Aman`,category:`Paham Konsep`,topics:[]},{name:`Rafa Pratama`,score:95,status:`Aman`,category:`Paham Konsep`,topics:[]},{name:`Intan Maulida`,score:72,status:`Aman`,category:`Paham Konsep`,topics:[`Pengaruh Konsentrasi`]}]},{id:`c2`,name:`XII IPA 2`,code:`KIM-138`,students:35,progress:66,quiz:7,roster:[{name:`Dimas Arga`,score:60,status:`Perhatian`,category:`Menebak`,topics:[`Pengaruh Suhu`]},{name:`Nabila Putri`,score:92,status:`Aman`,category:`Paham Konsep`,topics:[]},{name:`Budi Santoso`,score:42,status:`Kritis`,category:`Miskonsepsi`,topics:[`Pengaruh Konsentrasi`,`Kesetimbangan Heterogen`]}]}],Af=Ef.flatMap(e=>[{id:e.id+`_t1`,tier:1,type:e.topic,question:e.tier1.question,options:e.tier1.options,answer:e.tier1.answer,reason:``},{id:e.id+`_t3`,tier:3,type:e.topic,question:e.tier3.question,options:e.tier3.options,answer:e.tier3.answer,reason:``}]),jf={"Konsep Dasar Kesetimbangan":{nextOnSuccess:`Kesetimbangan Dinamis`,nextOnFail:`Kesetimbangan Dinamis`},"Kesetimbangan Dinamis":{nextOnSuccess:`Pengaruh Konsentrasi`,nextOnFail:`Pengaruh Konsentrasi`},"Pengaruh Konsentrasi":{nextOnSuccess:`Pengaruh Tekanan dan Volume`,nextOnFail:`Pengaruh Tekanan dan Volume`},"Pengaruh Tekanan dan Volume":{nextOnSuccess:`Pengaruh Suhu`,nextOnFail:`Pengaruh Suhu`},"Pengaruh Suhu":{nextOnSuccess:`Peran Katalis`,nextOnFail:`Peran Katalis`},"Peran Katalis":{nextOnSuccess:`Tetapan Kesetimbangan Kc`,nextOnFail:`Tetapan Kesetimbangan Kc`},"Tetapan Kesetimbangan Kc":{nextOnSuccess:`Hubungan Kp dan Kc`,nextOnFail:`Hubungan Kp dan Kc`},"Hubungan Kp dan Kc":{nextOnSuccess:`Kesetimbangan Heterogen`,nextOnFail:`Kesetimbangan Heterogen`},"Kesetimbangan Heterogen":{nextOnSuccess:`Aplikasi Industri (Proses Haber)`,nextOnFail:`Aplikasi Industri (Proses Haber)`},"Aplikasi Industri (Proses Haber)":{nextOnSuccess:`END`,nextOnFail:`END`}},Mf={first_ar:{emoji:``,name:`Ilmuwan Pemula`,desc:`Selesaikan misi WebAR pertama`},le_chatelier:{emoji:`️`,name:`Ahli Le Chatelier`,desc:`Jawab benar semua soal suhu, tekanan & konsentrasi`},no_misconc:{emoji:``,name:`Bebas Miskonsepsi`,desc:`Selesaikan kuis tanpa miskonsepsi`},speed_demon:{emoji:``,name:`Kilat`,desc:`Selesaikan kuis dalam waktu < 5 menit`},perfect:{emoji:``,name:`Sempurna`,desc:`Jawab semua soal dengan benar`},ar_explorer:{emoji:``,name:`Penjelajah AR`,desc:`Selesaikan semua misi WebAR`}},Nf={role:`siswa`,page:`login`,joinedClass:!1,selectedClassIndex:0,activeModuleFilter:`all`,activeModule:null,webarMisiAktif:null,webarHookMisi:null,viewedMisi:[],currentSetIndex:0,currentTier:1,currentBloomLevel:1,quizResults:[],selectedOption:null,confidence:null,quizTimeLeft:600,quizTimerActive:!1,colorblind:!1,points:0,gems:0,badges:[],aiRecommendations:[],profile:{siswa:{name:``,email:``,school:``,className:``,password:``},guru:{name:``,email:``,school:``,className:``,password:``}},modules:Of,questions:Af,classes:kf,teacherEditingQuestionId:null},Pf={currentUser:null,users:{}},Z=zf(),Ff=document.getElementById(`app`),If=document.getElementById(`toast`),Lf,Rf=null;function zf(){try{let e=JSON.parse(localStorage.getItem(`archemyDB`));e&&typeof e==`object`&&e.users&&(Pf=e)}catch{}let e={};Pf.currentUser&&Pf.users[Pf.currentUser]&&(e=Pf.users[Pf.currentUser]);let t=structuredClone(Nf);if(!e||Object.keys(e).length===0)return localStorage.removeItem(`archemyState`),t;let n={...t,...e,profile:{...t.profile,...e.profile||{}},modules:e.modules?.length?e.modules:t.modules,questions:e.questions?.length?e.questions:t.questions,classes:e.classes?.length?e.classes:t.classes,badges:e.badges||[],points:e.points||0,gems:e.gems||0,aiRecommendations:e.aiRecommendations||[],viewedMisi:e.viewedMisi||[]};return n.webarMisiAktif&&(n.webarMisiAktif=null,n.page=`studentDashboard`),n}function Q(){Pf.currentUser&&(Pf.users[Pf.currentUser]=Z,localStorage.setItem(`archemyDB`,JSON.stringify(Pf)))}function Bf(){Pf.currentUser=null,Z=structuredClone(Nf),Q(),localStorage.removeItem(`archemyState`),Uf(`login`)}function Vf(e){clearTimeout(Lf),If.textContent=e,If.classList.add(`show`),Lf=setTimeout(()=>If.classList.remove(`show`),2500)}function Hf(e){Z.role=e,Q(),fm()}function Uf(e){Z.page===`studentWebAR`&&e!==`studentWebAR`&&wf(),Z.page=e,e!==`studentModules`&&(Z.activeModule=null),[`studentQuiz`,`studentQuizPage`].includes(e)||(Z.selectedOption=null,Z.confidence=null),Q(),fm(),requestAnimationFrame(()=>window.scrollTo({top:0,behavior:`instant`}))}function Wf(){return Z.profile[Z.role]}function Gf(){return Z.classes[Z.selectedClassIndex]||Z.classes[0]}function Kf(){return![`login`,`register`,`joinClass`,`teacherClasses`].includes(Z.page)&&Z.page!==`studentWebAR`}function qf(){Z.role===`siswa`?Uf(Z.joinedClass?`studentDashboard`:`joinClass`):Uf(`teacherClasses`)}function Jf(){return Z.role===`siswa`?`studentDashboard`:`teacherClasses`}function Yf(e,t=``){Z.points=(Z.points||0)+e,Z.gems=(Z.gems||0)+Math.floor(e/5),Q(),Vf(`+${e} XP ${t?`- `+t:``}`)}function Xf(e){if(Z.badges||=[],Z.badges.includes(e))return;let t=Mf[e];t&&(Z.badges.push(e),Q(),tp(`${t.emoji} Badge Baru Diraih!`,`<div style="text-align:center;padding:10px 0;">
  ...
  </button>`}function Ep(e){Z.activeModule=e,Q(),fm()}function Dp(){Z.activeModule=null,Q(),fm()}function Op(e){return e?`<div class="sheet"><div class="sheet-title"><h3> Ringkasan AI</h3><span class="pill">${Cp(e.type)}</span></div>
  ...
  `)}function Vp(){let e=(Z.aiRecommendations||[]).filter(e=>e.type===`misi`).map(e=>e.id);!Z.webarMisiAktif&&!Z.webarHookMisi?(ap(`${rp({back:!0,titleBackPage:`studentDashboard`,coins:!1})}<div id="webarContainer"></div>`,{noNav:!0}),Sf(document.getElementById(`webarContainer`),e=>{Z.webarHookMisi=e,Q(),fm()},e,()=>{window.go(Z.role===`siswa`?Z.joinedClass?`studentDashboard`:`joinClass`:`teacherClasses`)})):Z.webarHookMisi&&!Z.webarMisiAktif?(Ff.innerHTML=``,xf(Ff,Z.webarHookMisi,()=>{Z.webarMisiAktif=Z.webarHookMisi,Z.webarHookMisi=null,Z.viewedMisi||=[],Z.viewedMisi.includes(Z.webarMisiAktif)||Z.viewedMisi.push(Z.webarMisiAktif),Q(),fm()})):(Ff.innerHTML=``,Cf(Ff,Z.webarMisiAktif,e=>{e?.completed&&(Yf(50,`misi WebAR selesai`),Zf(`ar`)),Z.webarMisiAktif=null,Z.webarHookMisi=null,Q(),fm()}))}function Hp(){Z.colorblind=!Z.colorblind,document.body.classList.toggle(`colorblind-mode`,Z.colorblind),Q(),fm()}function Up(){ap(`
    ...
    <div style="padding:0 28px;margin-top:20px;"><button class="btn ghost full" onclick="window.showAddClassModal()">+ Buat Kelas Baru</button></div>`,{noNav:!0}),setTimeout(Gp,60)}var Wp=0;function Gp(){Wp=Z.selectedClassIndex||0,Kp()}function Kp(){let e=document.getElementById(`coverflowTrack`);if(!e)return;let t=e.querySelectorAll(`.coverflow-slide`),n=t.length;t.forEach((e,t)=>{let r=t-Wp;n>2&&(r>Math.floor(n/2)&&(r-=n),r<-Math.floor(n/2)&&(r+=n));let i=Math.abs(r),a=Math.sign(r),o=i===0?1.05:.85,s=i===0?0:a*140;e.style.transform=`translateX(${s}px) scale(${o})`,e.style.zIndex=i===0?100:50,e.style.opacity=i===0?1:.4,e.style.pointerEvents=i===0?`auto`:`none`})}function qp(e){let t=Z.classes.length;t!==0&&(Wp=(Wp+e+t)%t,Kp())}function Jp(e){Z.selectedClassIndex=e,Q(),Uf(`teacherDashboard`)}function Yp(){let e=Gf();ap(`${rp({coins:!1,back:!0,titleBackPage:`teacherClasses`})}
    ...
    </div>`)}function Xp(){tp(`Buat Kelas Baru`,`<div class="field"><label>Nama Kelas Baru</label><input id="newClassName" class="input" placeholder="Contoh: XI IPA 4"></div>`,`<button class="btn full" onclick="window.addClass()">Buat Kelas</button><button class="btn ghost full" onclick="window.closeModal()">Batal</button>`)}function Zp(){let e=document.getElementById(`newClassName`).value.trim();if(!e)return Vf(`Isi nama kelas!`);let t=`KIM-${Math.floor(140+Math.random()*850)}`;Z.classes.push({id:`c${Date.now()}`,name:e,code:t,students:32,progress:0,quiz:10,roster:[]}),Z.selectedClassIndex=Z.classes.length-1,Q(),np(),fm(),Vf(`Kelas baru ${t} aktif! `)}function Qp(){let e=Gf();ap(`${rp({coins:!1,back:!0,titleBackPage:`teacherDashboard`})}
    ...
    </div>`)}function $p(){ap(`${rp({coins:!1,back:!0,titleBackPage:`teacherDashboard`})}
  ...
  `)}function lm(){if(typeof html2pdf>`u`){Vf(` Library PDF belum dimuat.`);return}let e=document.getElementById(`area-cetak-laporan`),t=Z.classes[Z.selectedClassIndex]?.name||`Kelas`;Vf(` Memproses PDF...`);let n=e.querySelectorAll(`.pdf-only-section`);n.forEach(e=>e.style.display=`block`);let r={margin:[15,12,15,12],filename:`Laporan_ARChemy_${t}.pdf`,image:{type:`jpeg`,quality:.98},html2canvas:{scale:2,useCORS:!0,logging:!1},jsPDF:{unit:`mm`,format:`a4`,orientation:`portrait`}};try{html2pdf().set(r).from(e).save().then(()=>{Vf(`PDF Berhasil diunduh!`),n.forEach(e=>e.style.display=`none`)}).catch(()=>{Vf(`Gagal ekspor PDF.`),n.forEach(e=>e.style.display=`none`)})}catch(e){Vf(`Gagal: `+e.message),n.forEach(e=>e.style.display=`none`)}}function um(){let e=Wf(),t=(Z.badges||[]).map(e=>Mf[e]?`<div class="badge-card"><span class="badge-emoji">${Mf[e].emoji}</span><div><b>${Mf[e].name}</b><span class="small muted" style="display:block">${Mf[e].desc}</span></div></div>`:``).join(``);ap(`${rp({back:!0,titleBackPage:Z.role===`siswa`?`studentDashboard`:`teacherDashboard`,coins:Z.role===`siswa`})}
    ...
    <div class="actions-row" style="margin-top:14px;"><button class="btn danger full" onclick="window.logout()">Logout Akun</button></div>`)}function dm(e){return(e||``).split(` `)[0]||`User`}function $(e){return String(e??``).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#039;`})[e])}function fm(){let e={login:op,register:cp,joinClass:up,studentDashboard:pp,studentModules:yp,studentQuiz:jp,studentQuizPage:Mp,studentResult:Bp,studentWebAR:Vp,studentAdaptivePath:gp,teacherClasses:Up,teacherDashboard:Yp,teacherModules:$p,teacherQuiz:nm,teacherEditQuiz:am,teacherAnalysis:sm,teacherTopicDetail:cm,profile:um,teacherClassDetail:Qp};try{(e[Z.page]||op)()}catch(e){console.error(`[ARChemy Render Error]`,e),Ff.innerHTML=`<section class="screen" style="text-align:center;padding-top:80px;"><h2 style="color:var(--danger);">Terjadi Kesalahan</h2><p class="muted" style="font-size:13px;">${$(e.message)}</p><button class="btn" style="margin-top:16px;" onclick="window.state.page='login';window.render();">Kembali ke Login</button><button class="btn ghost" style="margin-top:8px;" onclick="localStorage.removeItem('archemyState');location.reload();">Reset Data</button></section>`}}typeof window<`u`&&(window.state=Z,window.saveState=Q,window.toast=Vf,window.go=Uf,window.goHome=qf,window.setRole=Hf,window.logout=Bf,window.closeModal=np,window.submitLogin=sp,window.submitRegister=lp,window.fillCode=dp,window.joinClass=fp,window.setModuleFilter=xp,window.openModule=Ep,window.closeModule=Dp,window.openModuleFromPath=_p,window.goToMisi=vp,window.startQuiz=kp,window.selectOption=Np,window.selectConfidence=Pp,window.saveAndNext=Fp,window.resetQuiz=zp,window.jalankanLompatanAdaptif=Ip,window.executeQuizEnd=Rp,window.toggleColorblind=Hp,window.moveCoverflow=qp,window.selectCoverflowClass=Jp,window.showAddClassModal=Xp,window.addClass=Zp,window.addModuleWithAI=em,window.deleteModule=tm,window.newQuestion=rm,window.saveQuestion=om,window.eksporLaporanPDF=lm,window.editQuestion=im,window.teacherTopicDetail=e=>{Z.activeTopic=e,Uf(`teacherTopicDetail`)},window.render=fm),fm();