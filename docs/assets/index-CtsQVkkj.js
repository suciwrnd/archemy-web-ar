...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ks(e,t,n){let r=new Float32Array(hs),i=new H(0,1,0);return new Ta({name:`SphericalGaussianBlur`,defines:{n:hs,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ms(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function As(){return new Ta({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ms(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function js(){return new Ta({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ms(),fragmentShader:`
	...
	`}var Ns=class extends Xt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new na(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var il={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function al(e,t){let n=il[t];return n===void 0?(L(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var ol=new H;function sl(){return W.getLuminanceCoefficients(ol),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${ol.x.toFixed(4)}, ${ol.y.toFixed(4)}, ${ol.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=Xc(i,i.VERTEX_SHADER,y),S=Xc(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=nl(i,x,`vertex`),n=nl(i,S,`fragment`);R(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `),document.getElementById(`meAddReactant`).onclick=()=>{this.simulator.addMolecules(!1,5),qd.whoosh()},document.getElementById(`meAddProduct`).onclick=()=>{this.simulator.addMolecules(!0,5),qd.whoosh()},document.getElementById(`meCloseCtx`).onclick=()=>this.ui.hideContextPanel();else if(e===`monitor`){let e=this.simulator.getCurrentRatio();this.ui.showContextPanel(`LAYAR MONITOR (INDIKATOR)`,`
  ...
  `,e.querySelector(`#hookContinue`).addEventListener(`click`,()=>{qd.whoosh(),n()})}function bf(e,t,n=[],r){let i=window.state?.viewedMisi||[],a=Tu(),o={H2I2:`misi1`,NO2_N2O4:`misi2`,FeSCN:`misi3`,AceticAcid:`misi4`},s=a.map(e=>{let t=o[e.id]||e.id,r=i.includes(t)||i.includes(e.id),a=n.includes(t)||n.includes(e.id),s=e.accentColor?`#${e.accentColor.toString(16).padStart(6,`0`)}`:`#4fc3f7`;return`
  ...
  `,e.querySelectorAll(`.me-misi-card`).forEach(e=>{e.addEventListener(`click`,()=>t(e.dataset.misi))}),r){let t=e.querySelector(`#btnBackPilih`);t&&t.addEventListener(`click`,r)}}async function xf(e,t,n){let r=wu(Du(t));if(!r)return;_f(),e.innerHTML=`
...
`+e.stack)}let u=!1,d=e=>{if(e?.preventDefault&&e.preventDefault(),!u){if(!l){alert(`Sesi belum siap atau gagal dimuat.`);return}u=!0,l&&l.startSession();try{document.documentElement.requestFullscreen&&document.documentElement.requestFullscreen().catch(()=>{})}catch{}o.style.opacity=`0`,o.style.pointerEvents=`none`,setTimeout(()=>{o.style.display=`none`},500)}},f=e.querySelector(`#btnMasuk`);f&&(f.addEventListener(`click`,d),f.addEventListener(`touchstart`,d,{passive:!1}));let p=e=>{if(e?.preventDefault&&e.preventDefault(),!u){if(!l){alert(`Sesi belum siap atau gagal dimuat.`);return}u=!0,l&&l.startSession(!0);try{document.documentElement.requestFullscreen&&document.documentElement.requestFullscreen().catch(()=>{})}catch{}o.style.opacity=`0`,o.style.pointerEvents=`none`,setTimeout(()=>{o.style.display=`none`},500)}},m=e.querySelector(`#btnMasuk3D`);m&&(m.addEventListener(`click`,p),m.addEventListener(`touchstart`,p,{passive:!1}))}function Sf(){vf&&=(vf.hentikan?.(),null)}var Cf={bell:`<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 22a2.7 2.7 0 0 0 2.65-2.15h-5.3A2.7 2.7 0 0 0 12 22Zm7-6.4-1.45-1.95V9.2A5.56 5.56 0 0 0 13 3.75V2h-2v1.75A5.56 5.56 0 0 0 6.45 9.2v4.45L5 15.6V18h14v-2.4Z"/></svg>`,user:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><circle cx="12" cy="8" r="4"/><path d="M4 21c1.7-4.2 5-6 8-6s6.3 1.8 8 6"/></svg>`,home:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M3 11.5 12 4l9 7.5"/><path d="M5.5 10.5V21h13V10.5"/><path d="M9.3 21v-6h5.4v6"/></svg>`,checklist:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><rect x="4" y="3.8" width="16" height="16.4" rx="2"/><path d="m8 8 1.5 1.5L12 7"/><path d="M14 8.5h2.5"/><path d="m8 14 1.5 1.5L12 13"/><path d="M14 14.5h2.5"/></svg>`,ar:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M8 3H5a2 2 0 0 0-2 2v3"/><path d="M16 3h3a2 2 0 0 1 2 2v3"/><path d="M8 21H5a2 2 0 0 1-2-2v-3"/><path d="M16 21h3a2 2 0 0 0 2-2v-3"/><circle cx="12" cy="12" r="3"/><path d="M12 9V6m0 12v-3m3-3h3m-12 0h3"/></svg>`,book:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M4 5.5A3.5 3.5 0 0 1 7.5 2H20v17H7.5A3.5 3.5 0 0 0 4 22V5.5Z"/><path d="M4 19.5A3.5 3.5 0 0 1 7.5 16H20"/></svg>`,file:`<svg viewBox="0 0 24 24" fill="currentColor"><path d="M6 2h8.2L20 7.8V22H6V2Zm8 1.7V8h4.3L14 3.7Z"/></svg>`,play:`<svg viewBox="0 0 24 24" fill="currentColor"><path d="M5 4.8A2.8 2.8 0 0 1 7.8 2h8.4A2.8 2.8 0 0 1 19 4.8v14.4a2.8 2.8 0 0 1-2.8 2.8H7.8A2.8 2.8 0 0 1 5 19.2V4.8Zm5 4v6.4l5.4-3.2L10 8.8Z"/></svg>`,link:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M10 13.5a4 4 0 0 0 5.6.4l2.3-2.3a4 4 0 1 0-5.7-5.7l-1.3 1.3"/><path d="M14 10.5a4 4 0 0 0-5.6-.4l-2.3 2.3a4 4 0 0 0 5.7 5.7l1.3-1.3"/></svg>`,people:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><circle cx="9" cy="8" r="3"/><path d="M3 19c1.1-3.2 3.4-5 6-5s4.9 1.8 6 5"/><circle cx="17" cy="9" r="2.3"/><path d="M15.5 14.7c2.4.2 4.2 1.7 5.2 4.3"/></svg>`,plus:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M12 5v14M5 12h14"/></svg>`,trash:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M4 7h16M9 7V4h6v3M7 7l1 14h8l1-14"/></svg>`,edit:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M4 20h4l10.5-10.5a2.1 2.1 0 0 0-3-3L5 17v3Z"/><path d="m14 8 2 2"/></svg>`,logout:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M10 4H5v16h5"/><path d="M14 8l4 4-4 4"/><path d="M8 12h10"/></svg>`,brain:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M9 4a3 3 0 0 0-3 3 3 3 0 0 0-1 5.7A3.5 3.5 0 0 0 8.5 18H9V4Z"/><path d="M15 4a3 3 0 0 1 3 3 3 3 0 0 1 1 5.7A3.5 3.5 0 0 1 15.5 18H15V4Z"/><path d="M9 8c-1.4 0-2.5.8-3 2M15 8c1.4 0 2.5.8 3 2M9 14c-1.2.2-2 .9-2.5 2M15 14c1.2.2 2 .9 2.5 2"/></svg>`,star:`<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2l2.9 6.1 6.6.9-4.8 4.7 1.1 6.6L12 17.3l-5.8 3 1.1-6.6L2.5 9l6.6-.9z"/></svg>`,gem:`<svg viewBox="0 0 24 24" fill="currentColor"><path d="M6.5 2h11l4.5 6-10 14L2 8zm.5 2L4 8h4.5l2-4zm5 0 2 4H14l-1.5-4zm6.5 2h-2.5l-2-4H16zM5.5 10l4.5 9.5L5 10zm6.5 9.5L16.5 10H8zm5-9.5h-4.5l4.5 9.5z"/></svg>`,trophy:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M8 21h8M12 17v4"/><path d="M5 3H3v5a4 4 0 0 0 4 4h1"/><path d="M19 3h2v5a4 4 0 0 1-4 4h-1"/><rect x="6" y="3" width="12" height="11" rx="1"/></svg>`,map:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="m3 7 6-3 6 3 6-3v13l-6 3-6-3-6 3V7z"/><path d="M9 4v13M15 7v13"/></svg>`,chart:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M3 3v18h18"/><path d="m7 11 4-4 4 4 4-4"/></svg>`,check:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M20 6 9 17l-5-5"/></svg>`},wf=[{id:`qs1`,topic:`Konsep Dasar Kesetimbangan`,bloomLevel:1,bloomLabel:`C1 - Mengingat`,tier1:{question:`Suatu reaksi dikatakan berada dalam keadaan setimbang apabila...`,options:[`Reaksi telah berhenti sepenuhnya dan tidak ada perubahan`,`Laju reaksi maju sama dengan laju reaksi balik`,`Semua reaktan telah habis bereaksi membentuk produk`,`Konsentrasi reaktan selalu lebih besar dari konsentrasi produk`],answer:1},tier3:{question:`Alasan ilmiah yang mendukung jawaban Anda adalah...`,options:[`Pada keadaan setimbang, laju pembentukan produk sama dengan laju penguraian produk kembali menjadi reaktan, sehingga konsentrasi tampak tetap`,`Kesetimbangan tercapai karena semua molekul berhenti bergerak`,`Kesetimbangan hanya terjadi jika suhu dan tekanan sistem adalah nol`,`Pada kesetimbangan, energi kinetik semua partikel menjadi sama besar`],answer:0}},{id:`qs2`,topic:`Kesetimbangan Dinamis`,bloomLevel:2,bloomLabel:`C2 - Memahami`,tier1:{question:`Pada kesetimbangan dinamis, pernyataan yang paling tepat adalah...`,options:[`Reaksi maju dan balik sudah berhenti sama sekali`,`Konsentrasi reaktan dan produk terus berubah secara drastis`,`Reaksi maju dan balik tetap berlangsung dengan laju yang sama sehingga komposisi campuran tetap`,`Hanya reaksi ke arah produk yang masih berlangsung`],answer:2},tier3:{question:`Dasar ilmiah yang menjelaskan kesetimbangan dinamis adalah...`,options:[`On a molecular level, collisions between particles still occur and forward-reverse reactions proceed simultaneously, but the net change in concentration is zero`,`Molekul berhenti bergerak begitu sistem mencapai kesetimbangan`,`Energi kinetik rata-rata semua molekul menjadi nol pada keadaan setimbang`,`Kesetimbangan dinamis hanya dapat terjadi pada tekanan sangat tinggi`],answer:0}},{id:`qs3`,topic:`Pengaruh Konsentrasi`,bloomLevel:3,bloomLabel:`C3 - Mengaplikasikan`,tier1:{question:`Pada reaksi: N₂(g) + 3H₂(g) ⇌ 2NH₃(g), jika konsentrasi N₂ ditambah, kesetimbangan akan...`,options:[`Bergeser ke kiri (arah reaktan)`,`Bergeser ke kanan (arah produk)`,`Tidak mengalami pergeseran`,`Reaksi langsung berhenti`],answer:1},tier3:{question:`Alasan ilmiah dari pergeseran kesetimbangan tersebut adalah...`,options:[`Sesuai Asas Le Chatelier, penambahan konsentrasi reaktan mendorong sistem bergeser ke arah produk untuk mengurangi gangguan`,`Penambahan N₂ menurunkan energi aktivasi reaksi maju saja`,`Gas N₂ yang ditambahkan langsung terurai menjadi atom nitrogen bebas`,`Konsentrasi reaktan tidak pernah mempengaruhi posisi kesetimbangan`],answer:0}},{id:`qs4`,topic:`Pengaruh Tekanan dan Volume`,bloomLevel:3,bloomLabel:`C3 - Mengaplikasikan`,tier1:{question:`Pada reaksi: 2SO₂(g) + O₂(g) ⇌ 2SO₃(g), jika tekanan dinaikkan, kesetimbangan akan...`,options:[`Bergeser ke kiri karena mol gas reaktan lebih sedikit`,`Bergeser ke kanan karena mol gas produk lebih sedikit`,`Tidak berubah karena tekanan tidak mempengaruhi kesetimbangan gas`,`Bergeser ke kiri karena SO₃ lebih berat dari SO₂`],answer:1},tier3:{question:`Prinsip yang mendasari pengaruh tekanan ini adalah...`,options:[`Peningkatan tekanan menggeser sistem ke sisi dengan jumlah mol gas lebih sedikit (3 mol → 2 mol) sesuai Asas Le Chatelier`,`Tekanan tinggi selalu menguntungkan produk pada semua reaksi`,`Tekanan hanya mempengaruhi reaksi fase cair`,`Peningkatan tekanan selalu menghentikan reaksi kesetimbangan`],answer:0}},{id:`qs5`,topic:`Pengaruh Suhu`,bloomLevel:3,bloomLabel:`C3 - Mengaplikasikan`,tier1:{question:`Reaksi: N₂O₄(g) ⇌ 2NO₂(g), ΔH = +57 kJ/mol. Jika suhu dinaikkan, kesetimbangan akan...`,options:[`Bergeser ke kiri sehingga N₂O₄ bertambah`,`Bergeser ke kanan sehingga NO₂ bertambah`,`Tidak mengalami pergeseran`,`Reaksi berubah menjadi ireversibel`],answer:1},tier3:{question:`Dasar ilmiah pengaruh suhu pada kesetimbangan ini adalah...`,options:[`Kenaikan suhu menyediakan kalor yang dimanfaatkan reaksi endoterm (ke kanan) untuk menyerap kelebihan kalor sesuai Asas Le Chatelier`,`Suhu tinggi selalu mempercepat semua reaksi ke arah produk`,`Perubahan suhu hanya mempengaruhi laju reaksi, tidak mengubah tetapan kesetimbangan`,`Kenaikan suhu menurunkan energi aktivasi reaksi balik saja`],answer:0}},{id:`qs6`,topic:`Peran Katalis`,bloomLevel:2,bloomLabel:`C2 - Memahami`,tier1:{question:`Penambahan katalis pada sistem kesetimbangan akan...`,options:[`Menggeser kesetimbangan ke arah produk`,`Menggeser kesetimbangan ke arah reaktan`,`Mempercepat tercapainya kesetimbangan tanpa mengubah posisi kesetimbangan`,`Menghentikan reaksi balik sepenuhnya`],answer:2},tier3:{question:`Alasan katalis tidak mengubah posisi kesetimbangan adalah...`,options:[`Katalis menurunkan energi aktivasi reaksi maju dan balik secara proporsional sama, sehingga perbandingan laju tidak berubah`,`Katalis hanya mempengaruhi warna larutan`,`Katalis menambah jumlah mol produk melalui reaksi samping`,`Katalis menyerap seluruh energi kinetik molekul gas`],answer:0}},{id:`qs7`,topic:`Tetapan Kesetimbangan Kc`,bloomLevel:4,bloomLabel:`C4 - Menganalisis`,tier1:{question:`Untuk reaksi: 2A(g) + B(g) ⇌ 3C(g), ekspresi Kc yang benar adalah...`,options:[`Kc = [A]²[B] / [C]³`,`Kc = [C]³ / ([A]²[B])`,`Kc = [C] / ([A][B])`,`Kc = ([A] + [B]) / [C]`],answer:1},tier3:{question:`Prinsip penulisan ekspresi Kc tersebut didasarkan pada...`,options:[`Kc merupakan perbandingan konsentrasi produk berpangkat koefisien dibagi konsentrasi reaktan berpangkat koefisien`,`Nilai Kc selalu sama dengan 1`,`Koefisien reaksi tidak mempengaruhi ekspresi Kc`,`Kc dihitung dari penjumlahan konsentrasi semua zat`],answer:0}},{id:`qs8`,topic:`Hubungan Kp dan Kc`,bloomLevel:4,bloomLabel:`C4 - Menganalisis`,tier1:{question:`Hubungan antara Kp and Kc dinyatakan oleh rumus...`,options:[`Kp = Kc × (RT)^Δn`,`Kp = Kc / (RT)`,`Kp = Kc + RT`,`Kp = Kc × R`],answer:0},tier3:{question:`Makna Δn dalam hubungan Kp = Kc(RT)^Δn adalah...`,options:[`Selisih jumlah koefisien mol gas produk dikurangi koefisien mol gas reaktan`,`Jumlah total mol semua zat`,`Jumlah mol reaktan saja`,`Δn selalu bernilai positif untuk setiap reaksi`],answer:0}},{id:`qs9`,topic:`Kesetimbangan Heterogen`,bloomLevel:4,bloomLabel:`C4 - Menganalisis`,tier1:{question:`Pada reaksi: CaCO₃(s) ⇌ CaO(s) + CO₂(g), ekspresi Kc yang benar adalah...`,options:[`Kc = [CaO][CO₂] / [CaCO₃]`,`Kc = [CO₂]`,`Kc = 1 / [CO₂]`,`Kc = [CaCO₃] / ([CaO][CO₂])`],answer:1},tier3:{question:`Alasan ilmiah zat padat tidak dimasukkan ke ekspresi Kc adalah...`,options:[`Konsentrasi zat padat murni bersifat konstan dan sudah termasuk dalam nilai Kc`,`Zat padat tidak ikut bereaksi`,`Zat padat selalu habis bereaksi`,`Zat padat tidak memiliki massa molar`],answer:0}},{id:`qs10`,topic:`Aplikasi Industri (Proses Haber)`,bloomLevel:5,bloomLabel:`C5 - Mengevaluasi`,tier1:{question:`Dalam proses Haber: N₂(g) + 3H₂(g) ⇌ 2NH₃(g), ΔH = −92 kJ/mol. Kondisi yang menguntungkan pembentukan NH₃ adalah...`,options:[`Suhu tinggi dan tekanan rendah`,`Suhu rendah dan tekanan tinggi`,`Suhu tinggi dan tekanan tinggi`,`Suhu rendah dan tekanan rendah`],answer:1},tier3:{question:`Namun dalam praktik industri digunakan suhu sedang (~450°C) karena...`,options:[`Suhu rendah menguntungkan kesetimbangan namun laju reaksi sangat lambat; suhu sedang dengan katalis besi dipilih sebagai kompromi`,`Suhu rendah merusak peralatan pabrik`,`Suhu tinggi diperlukan agar katalis tidak teroksidasi`,`Pada suhu rendah gas nitrogen membeku`],answer:0}}],Tf={"Konsep Dasar Kesetimbangan":{moduleId:`m1`,misiId:null,reason:`Pelajari pengantar kesetimbangan kimia terlebih dahulu.`},"Kesetimbangan Dinamis":{moduleId:`m2`,misiId:`misi1`,reason:`Visualisasikan kesetimbangan dinamis di Lab AR.`},"Pengaruh Konsentrasi":{moduleId:`m6`,misiId:`misi3`,reason:`Misi ini akan memperlihatkan bagaimana konsentrasi mempengaruhi reaksi.`},"Pengaruh Tekanan dan Volume":{moduleId:`m7`,misiId:`misi2`,reason:`Misi Operasi Smog akan menunjukkan pergeseran karena tekanan.`},"Pengaruh Suhu":{moduleId:`m6`,misiId:`misi1`,reason:`Misi Gas Iodin akan memperlihatkan efek perubahan suhu secara visual.`},"Peran Katalis":{moduleId:`m7`,misiId:null,reason:`Baca modul Mekanika Tekanan-Volume & Peran Katalisator.`},"Tetapan Kesetimbangan Kc":{moduleId:`m8`,misiId:null,reason:`Bank soal Kc/Qc akan membantu memahami ekspresi kesetimbangan.`},"Hubungan Kp dan Kc":{moduleId:`m8`,misiId:null,reason:`Pahami hubungan Kp dan Kc melalui contoh soal.`},"Kesetimbangan Heterogen":{moduleId:`m1`,misiId:null,reason:`Baca ulang modul pengantar mengenai zat padat dalam kesetimbangan.`},"Aplikasi Industri (Proses Haber)":{moduleId:`m5`,misiId:`misi4`,reason:`Misi Industri akan mensimulasikan kondisi optimal proses Haber.`}},Ef=[{id:`m1`,type:`file`,title:`Pengantar Kesetimbangan Kimia`,meta:`Dokumen • 18 halaman`,summary:`Materi ini menjelaskan konsep reaksi bolak-balik, keadaan setimbang, serta ciri sistem ketika laju reaksi maju dan balik sudah sama.`,points:[`Kesetimbangan bersifat dinamis.`,`Konsentrasi zat tampak tetap pada keadaan setimbang.`,`Sistem tertutup membantu reaksi mencapai setimbang.`],tips:[`Fokus pada perbedaan reaksi satu arah dan reaksi reversibel.`,`Gunakan tabel ICE untuk memahami perubahan konsentrasi.`],difficulty:`Rendah`,time:`10 Menit`,prereq:`Reaksi Kimia Dasar`},{id:`m2`,type:`file`,title:`Kesetimbangan Kimia Dinamis`,meta:`Dokumen • 22 halaman`,summary:`Membahas keadaan saat reaksi tetap berlangsung dua arah, tetapi perubahan makroskopis tidak terlihat karena laju reaksi maju sama dengan laju reaksi balik.`,points:[`Laju maju = laju balik.`,`Jumlah partikel dapat tetap walaupun reaksi tetap terjadi.`,`Kesetimbangan hanya terjadi pada sistem tertutup.`],tips:[`Bayangkan dua arah reaksi berjalan bersamaan.`,`Perhatikan tanda panah bolak-balik pada persamaan reaksi.`],difficulty:`Sedang`,time:`12 Menit`,prereq:`Konsep Reaksi Reversibel`},{id:`m3`,type:`video`,title:`Rahasia Partikel Tak Terlihat: Apa Itu Kesetimbangan Dinamis?`,meta:`Video • 15 menit`,summary:`Video memperlihatkan ilustrasi partikel yang terus bergerak dalam reaksi bolak-balik.`,points:[`Partikel tetap bergerak.`,`Reaksi maju dan balik terjadi bersamaan.`,`Perubahan terlihat stabil secara makroskopis.`],tips:[`Pause pada bagian animasi partikel.`,`Catat contoh reaksi yang digunakan dalam video.`],difficulty:`Sedang`,time:`15 Menit`,prereq:`Kesetimbangan Dinamis`},{id:`m4`,type:`file`,title:`Asas Le Chatelier`,meta:`Dokumen • 25 halaman`,summary:`Sistem kesetimbangan akan bergeser untuk mengurangi pengaruh perubahan yang diberikan.`,points:[`Konsentrasi naik → bergeser menjauhi zat yang ditambah.`,`Tekanan naik → bergeser ke sisi mol gas lebih kecil.`,`Suhu naik → bergeser ke arah reaksi endoterm.`,`Katalis tidak menggeser kesetimbangan.`],tips:[`Ingat konsep "melawan perubahan".`,`Bedakan pengaruh suhu, tekanan, volume, dan katalis.`,`Gunakan simulasi WebAR untuk melihat pergeseran.`],difficulty:`Tinggi`,time:`12 Menit`,prereq:`Kesetimbangan Kimia Dasar`},{id:`m5`,type:`video`,title:`Trik Asas Le Chatelier: Cara Pabrik Kimia Memaksa Reaksi Terus Berjalan`,meta:`Video • 15 menit`,summary:`Video menjelaskan bagaimana industri memanfaatkan Asas Le Chatelier.`,points:[`Tekanan dapat memengaruhi jumlah produk gas.`,`Suhu dipilih berdasarkan jenis reaksi.`,`Konsentrasi reaktan dapat diatur untuk mendorong produk.`],tips:[`Hubungkan materi dengan proses Haber.`,`Perhatikan contoh perubahan tekanan dan suhu.`],difficulty:`Rendah`,time:`17 Menit`,prereq:`Asas Le Chatelier`},{id:`m6`,type:`file`,title:`Pengaruh Parameter Suhu (Termal) & Konsentrasi Le Chatelier`,meta:`Dokumen • 20 halaman`,summary:`Materi ini membahas cara suhu dan konsentrasi mengubah arah pergeseran kesetimbangan.`,points:[`Penambahan reaktan mendorong pembentukan produk.`,`Suhu tinggi menguntungkan arah endoterm.`,`Suhu rendah menguntungkan arah eksoterm.`],tips:[`Tentukan dulu reaksi eksoterm atau endoterm.`,`Perhatikan sisi mana yang menerima penambahan zat.`],difficulty:`Tinggi`,time:`16 Menit`,prereq:`Asas Le Chatelier`},{id:`m7`,type:`file`,title:`Mekanika Tekanan-Volume & Peran Katalisator`,meta:`Dokumen • 19 halaman`,summary:`Materi membahas bagaimana perubahan tekanan dan volume mempengaruhi kesetimbangan gas serta peran katalis.`,points:[`Tekanan naik → ke arah mol gas lebih sedikit.`,`Volume naik → ke arah mol gas lebih banyak.`,`Katalis mempercepat, bukan menggeser.`],tips:[`Hitung jumlah mol gas di tiap sisi.`,`Ingat katalis menurunkan Ea maju dan balik sama besar.`],difficulty:`Sedang`,time:`14 Menit`,prereq:`Asas Le Chatelier`},{id:`m8`,type:`link`,title:`Bank Contoh Soal Kc dan Qc`,meta:`Link • Latihan soal`,summary:`Kumpulan contoh soal untuk membedakan nilai Kc dan Qc.`,points:[`Kc menunjukkan keadaan setimbang.`,`Qc digunakan untuk melihat arah reaksi.`,`Jika Qc < Kc, reaksi bergeser ke produk.`],tips:[`Tuliskan rumus Kc sesuai koefisien.`,`Bandingkan Qc dan Kc secara perlahan.`],difficulty:`Tinggi`,time:`18 Menit`,prereq:`Rumus Tetapan Kesetimbangan`}],Df=[{id:`c1`,name:`XII IPA 1`,code:`KIM-137`,students:36,progress:74,quiz:8,roster:[{name:`Adi Wijaya`,score:40,status:`Kritis`,category:`Miskonsepsi`,topics:[`Pengaruh Tekanan dan Volume`,`Pengaruh Suhu`]},{name:`Syela Cantika`,score:55,status:`Perhatian`,category:`Menebak`,topics:[`Tetapan Kesetimbangan Kc`]},{name:`Fajar Mahendra`,score:88,status:`Aman`,category:`Paham Konsep`,topics:[]},{name:`Rafa Pratama`,score:95,status:`Aman`,category:`Paham Konsep`,topics:[]},{name:`Intan Maulida`,score:72,status:`Aman`,category:`Paham Konsep`,topics:[`Pengaruh Konsentrasi`]}]},{id:`c2`,name:`XII IPA 2`,code:`KIM-138`,students:35,progress:66,quiz:7,roster:[{name:`Dimas Arga`,score:60,status:`Perhatian`,category:`Menebak`,topics:[`Pengaruh Suhu`]},{name:`Nabila Putri`,score:92,status:`Aman`,category:`Paham Konsep`,topics:[]},{name:`Budi Santoso`,score:42,status:`Kritis`,category:`Miskonsepsi`,topics:[`Pengaruh Konsentrasi`,`Kesetimbangan Heterogen`]}]}],Of=wf.flatMap(e=>[{id:e.id+`_t1`,tier:1,type:e.topic,question:e.tier1.question,options:e.tier1.options,answer:e.tier1.answer,reason:``},{id:e.id+`_t3`,tier:3,type:e.topic,question:e.tier3.question,options:e.tier3.options,answer:e.tier3.answer,reason:``}]),kf={"Konsep Dasar Kesetimbangan":{nextOnSuccess:`Kesetimbangan Dinamis`,nextOnFail:`Kesetimbangan Dinamis`},"Kesetimbangan Dinamis":{nextOnSuccess:`Pengaruh Konsentrasi`,nextOnFail:`Pengaruh Konsentrasi`},"Pengaruh Konsentrasi":{nextOnSuccess:`Pengaruh Tekanan dan Volume`,nextOnFail:`Pengaruh Tekanan dan Volume`},"Pengaruh Tekanan dan Volume":{nextOnSuccess:`Pengaruh Suhu`,nextOnFail:`Pengaruh Suhu`},"Pengaruh Suhu":{nextOnSuccess:`Peran Katalis`,nextOnFail:`Peran Katalis`},"Peran Katalis":{nextOnSuccess:`Tetapan Kesetimbangan Kc`,nextOnFail:`Tetapan Kesetimbangan Kc`},"Tetapan Kesetimbangan Kc":{nextOnSuccess:`Hubungan Kp dan Kc`,nextOnFail:`Hubungan Kp dan Kc`},"Hubungan Kp dan Kc":{nextOnSuccess:`Kesetimbangan Heterogen`,nextOnFail:`Kesetimbangan Heterogen`},"Kesetimbangan Heterogen":{nextOnSuccess:`Aplikasi Industri (Proses Haber)`,nextOnFail:`Aplikasi Industri (Proses Haber)`},"Aplikasi Industri (Proses Haber)":{nextOnSuccess:`END`,nextOnFail:`END`}},Af={first_ar:{emoji:``,name:`Ilmuwan Pemula`,desc:`Selesaikan misi WebAR pertama`},le_chatelier:{emoji:`️`,name:`Ahli Le Chatelier`,desc:`Jawab benar semua soal suhu, tekanan & konsentrasi`},no_misconc:{emoji:``,name:`Bebas Miskonsepsi`,desc:`Selesaikan kuis tanpa miskonsepsi`},speed_demon:{emoji:``,name:`Kilat`,desc:`Selesaikan kuis dalam waktu < 5 menit`},perfect:{emoji:``,name:`Sempurna`,desc:`Jawab semua soal dengan benar`},ar_explorer:{emoji:``,name:`Penjelajah AR`,desc:`Selesaikan semua misi WebAR`}},jf={role:`siswa`,page:`login`,joinedClass:!1,selectedClassIndex:0,activeModuleFilter:`all`,activeModule:null,webarMisiAktif:null,webarHookMisi:null,viewedMisi:[],currentSetIndex:0,currentTier:1,currentBloomLevel:1,quizResults:[],selectedOption:null,confidence:null,quizTimeLeft:600,quizTimerActive:!1,colorblind:!1,points:0,gems:0,badges:[],aiRecommendations:[],profile:{siswa:{name:``,email:``,school:``,className:``,password:``},guru:{name:``,email:``,school:``,className:``,password:``}},modules:Ef,questions:Of,classes:Df,teacherGeneratedQuizzes:[],teacherEditingQuestionId:null},Mf={currentUser:null,users:{}},Z=Lf(),Nf=document.getElementById(`app`),Pf=document.getElementById(`toast`),Ff,If=null;function Lf(){try{let e=JSON.parse(localStorage.getItem(`archemyDB`));e&&typeof e==`object`&&e.users&&(Mf=e)}catch{}let e={};Mf.currentUser&&Mf.users[Mf.currentUser]&&(e=Mf.users[Mf.currentUser]);let t=structuredClone(jf);if(!e||Object.keys(e).length===0)return localStorage.removeItem(`archemyState`),t;let n={...t,...e,profile:{...t.profile,...e.profile||{}},modules:e.modules?.length?e.modules:t.modules,questions:e.questions?.length?e.questions:t.questions,classes:e.classes?.length?e.classes:t.classes,teacherGeneratedQuizzes:e.teacherGeneratedQuizzes||[],badges:e.badges||[],points:e.points||0,gems:e.gems||0,aiRecommendations:e.aiRecommendations||[],viewedMisi:e.viewedMisi||[]};return n.webarMisiAktif&&(n.webarMisiAktif=null,n.page=`studentDashboard`),n}function Q(){Mf.currentUser&&(Mf.users[Mf.currentUser]=Z,localStorage.setItem(`archemyDB`,JSON.stringify(Mf)))}function Rf(){Mf.currentUser=null,Z=structuredClone(jf),Q(),localStorage.removeItem(`archemyState`),Vf(`login`)}function zf(e){clearTimeout(Ff),Pf.textContent=e,Pf.classList.add(`show`),Ff=setTimeout(()=>Pf.classList.remove(`show`),2500)}function Bf(e){Z.role=e,Q(),um()}function Vf(e){Z.page===`studentWebAR`&&e!==`studentWebAR`&&Sf(),Z.page=e,e!==`studentModules`&&(Z.activeModule=null),[`studentQuiz`,`studentQuizPage`].includes(e)||(Z.selectedOption=null,Z.confidence=null),Q(),um(),requestAnimationFrame(()=>window.scrollTo({top:0,behavior:`instant`}))}function Hf(){return Z.profile[Z.role]}function Uf(){return Z.classes[Z.selectedClassIndex]||Z.classes[0]}function Wf(){return![`login`,`register`,`joinClass`,`teacherClasses`].includes(Z.page)&&Z.page!==`studentWebAR`}function Gf(){Z.role===`siswa`?Vf(Z.joinedClass?`studentDashboard`:`joinClass`):Vf(`teacherClasses`)}function Kf(){return Z.role===`siswa`?`studentDashboard`:`teacherClasses`}function qf(e,t=``){Z.points=(Z.points||0)+e,Z.gems=(Z.gems||0)+Math.floor(e/5),Q(),zf(`+${e} XP ${t?`- `+t:``}`)}function Jf(e){if(Z.badges||=[],Z.badges.includes(e))return;let t=Af[e];t&&(Z.badges.push(e),Q(),$f(`${t.emoji} Badge Baru Diraih!`,`<div style="text-align:center;padding:10px 0;">
     ...
     </div>`,`<button class="btn full" onclick="window.closeModal()">Lanjutkan </button>`))}function Yf(e=`quiz`){if(e===`quiz`){let e=Z.quizResults;if(!e.length)return;e.every(e=>e.category!==`Miskonsepsi`)&&setTimeout(()=>Jf(`no_misconc`),800),600-Z.quizTimeLeft<300&&setTimeout(()=>Jf(`speed_demon`),1200),e.every(e=>e.tier1Correct&&e.tier3Correct)&&setTimeout(()=>Jf(`perfect`),1600);let t=[`Pengaruh Suhu`,`Pengaruh Tekanan dan Volume`,`Pengaruh Konsentrasi`],n=e.filter(e=>t.includes(e.topic));n.length===t.length&&n.every(e=>e.tier1Correct&&e.tier3Correct)&&setTimeout(()=>Jf(`le_chatelier`),2e3)}e===`ar`&&(Z.viewedMisi||=[],Z.viewedMisi.length===1&&setTimeout(()=>Jf(`first_ar`),500),Object.keys(Ou).every(e=>Z.viewedMisi.includes(e))&&setTimeout(()=>Jf(`ar_explorer`),900))}function Xf(e){let t=[],n=new Set,r=new Set;return e.forEach(e=>{if(e.category===`Miskonsepsi`||e.category===`Tidak Paham`){let i=Tf[e.topic];i&&(i.moduleId&&!n.has(i.moduleId)&&(n.add(i.moduleId),t.push({topic:e.topic,type:`module`,id:i.moduleId,reason:i.reason,priority:`high`,category:e.category})),i.misiId&&!r.has(i.misiId)&&(r.add(i.misiId),t.push({topic:e.topic,type:`misi`,id:i.misiId,reason:i.reason,priority:`high`,category:e.category})))}else if(e.category===`Menebak`){let r=Tf[e.topic];r&&r.moduleId&&!n.has(r.moduleId)&&(n.add(r.moduleId),t.push({topic:e.topic,type:`module`,id:r.moduleId,reason:`Perkuat pemahamanmu dengan membaca ulang modul ini.`,priority:`medium`,category:e.category}))}}),t}var Zf={isOpen:!1,title:``,content:``,actions:``};function Qf(){let e=document.getElementById(`modalRoot`);if(e||(e=document.createElement(`div`),e.id=`modalRoot`,document.body.appendChild(e)),Zf.isOpen)e.innerHTML=`<div class="modal-overlay"><div class="modal"><h3 class="modal-title">${$(Zf.title)}</h3><div class="modal-body">${Zf.content}</div><div class="modal-actions">${Zf.actions}</div></div></div>`,e.offsetWidth,e.querySelector(`.modal-overlay`).classList.add(`show`);else{let t=e.querySelector(`.modal-overlay`);t?(t.classList.remove(`show`),setTimeout(()=>{e.innerHTML=``},300)):e.innerHTML=``}}function $f(e,t,n){Zf={isOpen:!0,title:e,content:t,actions:n},Qf()}function ep(){Zf.isOpen=!1,Qf()}function tp({back:e=!1,titleBackPage:t=null,coins:n=!0}={}){let r=Z.points||0,i=Z.gems||0;return`<div class="topbar">
    <button class="logo ${e?`back-logo`:``}" onclick="window.${e?`go('${t||Kf()}')`:`goHome()`}" aria-label="ARChemy">
      ${e?`<span class="back">‹</span>`:``}<b>ARC</b>hemy
    </button>
    <div class="topbar-right">
      <div class="header-actions">
        <button class="header-icon" onclick="window.toast('Belum ada notifikasi baru')" aria-label="notifikasi">${Cf.bell}</button>
        <button class="header-icon" onclick="window.go('profile')" aria-label="profil">${Cf.user}</button>
      </div>
      ${n&&Z.role===`siswa`?`<div class="coins"><span class="coin xp">${Cf.star} ${r}</span><span class="coin gem">${Cf.gem} ${i}</span></div>`:``}
      ${n&&Z.role===`guru`?`<div class="role-switch" title="Mode guru"></div>`:``}
    </div>
  </div>`}function np(){if(!Wf())return``;let e=Z.role===`siswa`?[[`studentDashboard`,Cf.home,`Beranda`],[`studentQuiz`,Cf.checklist,`Kuis`],[`studentWebAR`,Cf.ar,`WebAR`],[`studentModules`,Cf.book,`Modul`]]:[[`teacherDashboard`,Cf.home,`Dasbor`],[`teacherQuiz`,Cf.checklist,`Kuis`],[`teacherModules`,Cf.book,`Modul`]];return`<nav class="bottom-nav ${Z.role===`guru`?`three-items`:``}">${e.map(([e,t,n])=>`<button class="nav-item ${Z.page===e?`active`:``}" onclick="window.go('${e}')" aria-label="${n}">${t}</button>`).join(``)}</nav>`}function rp(e,t={}){Nf.innerHTML=`<section class="screen ${t.noNav?`no-nav`:``}">${e}</section>${np()}`,document.body.classList.toggle(`colorblind-mode`,Z.colorblind)}function ip(){Nf.innerHTML=`<section class="auth-screen">
    ...
    </div></section>`}function ap(){let e=document.getElementById(`loginEmail`).value.trim(),t=document.getElementById(`loginPass`).value.trim();if(!e||!t)return zf(`Email dan password tidak boleh kosong`);let n=Mf.users[e];if(!n)return zf(`Akun dengan email tersebut tidak ditemukan`);let r=n.profile[Z.role];if(!r||r.email!==e)return zf(`Akun ini tidak terdaftar sebagai ${Z.role}`);if(r.password!==t)return zf(`Password salah!`);Mf.currentUser=e,Z=n,Z.page=Z.role===`siswa`?Z.joinedClass?`studentDashboard`:`joinClass`:`teacherClasses`,Q(),zf(`Login berhasil 🚀`),um()}function op(){Nf.innerHTML=`<section class="auth-screen">
    ...
    </div></section>`}function sp(){let e=document.getElementById(`regName`).value.trim(),t=document.getElementById(`regEmail`).value.trim(),n=document.getElementById(`regSchool`).value.trim(),r=document.getElementById(`regPass`).value.trim();if(!e||!t||!n||!r)return zf(`Semua kolom wajib diisi`);if(Mf.users[t])return zf(`Email sudah terdaftar. Silakan login.`);let i=structuredClone(jf);i.role=Z.role,i.profile[Z.role]={name:e,email:t,school:n,password:r,className:``},Mf.users[t]=i,Mf.currentUser=t,Z=i,Z.page=Z.role===`siswa`?`joinClass`:`teacherClasses`,Q(),zf(`Akun berhasil dibuat 🚀`),um()}function cp(){rp(`${tp({coins:!1})}
    ...
    <div class="card"><div class="field"><label>Kode kelas</label><input id="classCode" class="input" placeholder="Contoh: KIM-137"></div><button class="btn full" onclick="window.joinClass()">Gabung Kelas</button></div>`,{noNav:!0})}function lp(){document.getElementById(`classCode`).value=`KIM-137`}function up(){let e=document.getElementById(`classCode`).value.trim().toUpperCase(),t=Z.classes.find(t=>t.code===e);if(!t)return zf(`Kode kelas belum ditemukan`);Z.joinedClass=!0,Z.profile.siswa.className=t.name,Z.selectedClassIndex=Z.classes.indexOf(t),Q(),zf(`Berhasil bergabung ke ${t.name} `),Vf(`studentDashboard`)}function dp(){let e=Z.profile.siswa,t=Z.modules.filter(e=>Z.quizResults.some(e=>e.topic)).length,n=Math.min(100,Math.round(t/Math.max(Z.modules.length,1)*100)),r=Math.min(100,Math.round(Z.quizResults.length/Math.max(wf.length,1)*100)),i=Object.keys(Ou).length,a=Z.viewedMisi?.length?Math.round(Z.viewedMisi.length/i*100):0,o=Z.quizResults.filter(e=>e.category===`Paham Konsep`).length,s=Z.quizResults.length||1,c=Math.round(o/s*100),l=100-c,u=Z.aiRecommendations?.length>0,d=Z.points||0,f=[{name:`Tiara Yanti`,pts:420},{name:`Joshua Den`,pts:380},{name:`Ambar`,pts:310},{name:lm(e.name),pts:d,isSelf:!0},{name:`Rafa Pratama`,pts:Math.max(d-15,50)},{name:`Nabila Putri`,pts:Math.max(d-40,30)},{name:`Dimas Arga`,pts:Math.max(d-70,10)}].sort((e,t)=>t.pts-e.pts),p=f.slice(0,3),m=f.slice(3),h=Z.badges?.length>0?Z.badges.map(e=>Af[e]?`<span class="badge-chip" title="${Af[e].desc}">${Af[e].emoji}</span>`:``).join(``):`<span class="small muted">Belum ada badge. Selesaikan kuis untuk mendapatkan badge! </span>`;rp(`${tp()}
    <h1 class="page-title">Halo ${lm(e.name)}! </h1><p class="page-subtitle">Siap berpetualang bersama Chemy?</p>
    ...
    <div class="card activity-card"><div class="flask"></div><div><h3 style="margin:0 0 12px">Progres Aktivitas</h3>${pp(`Modul yang sudah dipelajari`,n)}${pp(`Kuis yang sudah dikerjakan`,r)}${pp(`WebAR yang sudah disimulasikan`,a)}</div></div>

    <div class="card" style="margin-top:14px;"><h3 style="margin:0 0 10px">Kemampuan & Badge</h3>${pp(`Pemahaman baik`,c)}${pp(`Pemahaman kurang`,l,`red`)}<div class="badge-row">${h}</div><button class="btn small-btn ghost" style="margin-top:12px" onclick="window.go('studentResult')">Lihat detail kuis</button></div>

    <section class="leaderboard-wrap"><div class="podium">
      ${fp(p[1]?.name||`-`,`second`,p[1]?.pts||0)}
      ${fp(p[0]?.name||`-`,`first`,p[0]?.pts||0)}
      ${fp(p[2]?.name||`-`,`third`,p[2]?.pts||0)}
    </div><div class="rank-list">${m.map((e,t)=>`<div class="rank-row${e.isSelf?` top`:``}"><span>${t+4}.</span><span class="avatar-sm">${Cf.user}</span><span>${e.name}${e.isSelf?` (Kamu)`:``}</span><span style="margin-left:auto;font-size:11px;opacity:.7">${e.pts} XP</span></div>`).join(``)}</div></section>`)}function fp(e,t,n){return`<div class="podium-user ${t}"><div class="avatar">${Cf.user}</div><b>${lm(e)}</b><span style="font-size:9px;opacity:.7">${n} XP</span></div>`}function pp(e,t,n=``){return`<div class="progress-row"><span class="label">${e}</span><span class="pct">${t}%</span><div class="bar"><div class="bar-fill ${n}" style="--w:${t}%"></div></div></div>`}function mp(){let e=Z.aiRecommendations||[],t=Z.quizResults||[],n=t.filter(e=>e.category===`Paham Konsep`),r=t.filter(e=>e.category===`Menebak`),i=t.filter(e=>e.category===`Miskonsepsi`),a=t.filter(e=>e.category===`Tidak Paham`),o=e.filter(e=>e.type===`module`),s=e.filter(e=>e.type===`misi`),c=(e,t,n,r)=>t.length===0?``:`
    <div class="ap-section">
    ...
    </div>`:``},u={misi1:`Gas Iodin Reversibel`,misi2:`Operasi Smog Kota`,misi3:`Amonia Gas`,misi4:`Proses Haber`},d={misi1:``,misi2:``,misi3:``,misi4:``},f=e=>{let t=u[e.id]||e.id;return`<div class="ap-rec-card priority-${e.priority}" onclick="window.goToMisi('${e.id}')">
      <div class="ap-rec-icon">${d[e.id]||``}</div>
      <div>
      ...
      <span class="ap-arrow">›</span>
    </div>`},p=e.length===0?`<div class="empty-state" style="padding:28px;">
  ...
  </div>`:``;rp(`${tp({back:!0,titleBackPage:`studentDashboard`})}
    ...
    ${c(`Perlu Diperhatikan`,r,`️`,`menebak`)}
    ...
    <div class="ap-rec-list">${s.map(f).join(``)}</div>`:``}
    ...
    `:``}
  `)}function hp(e){Z.activeModule=e,Q(),Vf(`studentModules`)}function gp(e){Z.webarMisiAktif=e,Z.viewedMisi||=[],Z.viewedMisi.includes(e)||Z.viewedMisi.push(e),Q(),Vf(`studentWebAR`)}function _p(){let e=Z.activeModuleFilter,t=Z.modules.filter(t=>e===`all`||t.type===e),n=(Z.aiRecommendations||[]).filter(e=>e.type===`module`).map(e=>e.id);rp(`${tp()}<h1 class="page-title">Modul Pembelajaran</h1>
    <div class="tabs">${vp(`all`,`Semua`)}${vp(`file`,`File`)}${vp(`video`,`Video`)}${vp(`link`,`Link`)}</div>
    ${n.length>0?`<div class="rec-banner"> ${n.length} modul direkomendasikan AI untuk kamu</div>`:``}
    <div class="module-list">${t.map(e=>Cp(e,n)).join(``)||`<div class="empty-state">Belum ada modul.</div>`}</div>
    ${Z.activeModule?Ep(Z.modules.find(e=>e.id===Z.activeModule)):``}
  `)}function vp(e,t){return`<button class="tab ${Z.activeModuleFilter===e?`active`:``}" onclick="window.setModuleFilter('${e}')">${t}</button>`}function yp(e){Z.activeModuleFilter=e,Z.activeModule=null,Q(),um()}function bp(e){return e===`video`?`<div class="module-icon video">${Cf.play}</div>`:e===`link`?`<div class="module-icon link">${Cf.link}</div>`:`<div class="module-icon">${Cf.file}</div>`}function xp(e){return e===`file`?`Dokumen`:e===`video`?`Video`:`Link`}function Sp(e){return e===`file`?`type-doc`:e===`video`?`type-video`:`type-link`}function Cp(e,t=[]){let n=t.includes(e.id);return`<button class="module-card fold ${n?`rec-highlight`:``}" onclick="window.openModule('${e.id}')">
    ${n?`<div class="rec-badge-module"> Direkomendasikan AI</div>`:``}
    <div class="module-icon-wrap">${bp(e.type)}</div>
    <h3 class="module-title">${$(e.title)}</h3>
    <div class="module-meta"><span class="pill ${Sp(e.type)}">${xp(e.type)}</span><span class="pill ai"> Ringkasan AI</span></div>
  </button>`}function wp(e){Z.activeModule=e,Q(),um()}function Tp(){Z.activeModule=null,Q(),um()}function Ep(e){return e?`<div class="sheet"><div class="sheet-title"><h3> Ringkasan AI</h3><span class="pill">${xp(e.type)}</span></div>
    <div class="module-card" style="box-shadow:none;min-height:70px;margin-bottom:10px">${bp(e.type)}<div><h3 class="module-title">${$(e.title)}</h3><p class="small muted" style="margin:0">${$(e.meta)}</p></div></div>
  ...
  </div>`:``}function Dp(){Z.currentSetIndex=0,Z.currentTier=1,Z.currentBloomLevel=1,Z.quizResults=[],Z.selectedOption=null,Z.confidence=null,Z.quizTimeLeft=600,Z.quizTimerActive=!0,Z.aiRecommendations=[],Z.questionStartTime=Date.now(),Q(),Op(),Vf(`studentQuizPage`)}function Op(){clearInterval(If),If=setInterval(()=>{if(Z.quizTimeLeft<=0){Ip();return}Z.quizTimeLeft--;let e=document.getElementById(`quizTimer`);if(e){let t=Math.floor(Z.quizTimeLeft/60),n=Z.quizTimeLeft%60;e.textContent=` ${String(t).padStart(2,`0`)} : ${String(n).padStart(2,`0`)}`,e.classList.toggle(`warning`,Z.quizTimeLeft<60)}},1e3)}function kp(){if(Z.quizTimerActive){Vf(`studentQuizPage`);return}if(Z.quizResults.length>0){Vf(`studentResult`);return}rp(`${tp()}<h1 class="page-title">Kuis Adaptif 4-Tier</h1><p class="page-subtitle">Uji pemahamanmu tentang kesetimbangan kimia secara berlapis!</p>
    ...
    </div>`)}function Ap(){let e=wf[Z.currentSetIndex];if(!e)return Ip();let t=Z.currentTier,n=Z.currentSetIndex*4+(t-1),r=Math.round(n/40*100),i=Math.floor(Z.quizTimeLeft/60),a=Z.quizTimeLeft%60,o=[1,2,3,4].map(e=>e<t?`done`:e===t?`active`:``),s=e.bloomLabel||`C1 - Mengingat`;e.bloomLevel>=4||e.bloomLevel;let c=``;if(t===1||t===3){let n=t===1?e.tier1:e.tier3;c=`<div class="quiz-card">
    ...
    <div class="quiz-head">
      <div>
        ...
        <span style="font-size:10px;color:var(--muted)">Topik ${Z.currentSetIndex+1}/${wf.length}: ${$(e.topic)}</span>
      </div>
  ...
  `)}function jp(e){Z.selectedOption=e,Q(),um()}function Mp(e){Z.confidence=e,Q(),um()}function Np(){let e=Z.currentTier,t=Z.currentSetIndex,n=wf[t];if(!n)return Ip();if(e===1||e===3){if(Z.selectedOption===null)return zf(`Pilih opsi jawaban dulu!`)}else if(!Z.confidence)return zf(`Pilih tingkat keyakinan dulu!`);let r=Z.quizResults.find(e=>e.topic===n.topic);if(r||(r={topic:n.topic,setIndex:t,bloomLevel:n.bloomLevel},Z.quizResults.push(r)),e===1)r.tier1Answer=Z.selectedOption,r.tier1Correct=Z.selectedOption===n.tier1.answer;else if(e===2)r.tier2Confidence=Z.confidence;else if(e===3)r.tier3Answer=Z.selectedOption,r.tier3Correct=Z.selectedOption===n.tier3.answer;else if(e===4){r.tier4Confidence=Z.confidence,r.timeTaken=Math.round((Date.now()-(Z.questionStartTime||Date.now()))/1e3);let e=e=>e===`Yakin`||e===`Sangat Yakin`;r.tier1Correct&&e(r.tier2Confidence)&&r.tier3Correct&&e(r.tier4Confidence)?r.category=`Paham Konsep`:r.tier1Correct&&!e(r.tier2Confidence)?r.category=`Menebak`:!r.tier1Correct&&e(r.tier2Confidence)&&!r.tier3Correct&&e(r.tier4Confidence)?r.category=`Miskonsepsi`:r.category=`Tidak Paham`}if(Z.selectedOption=null,Z.confidence=null,e<4)Z.currentTier=e+1,Q(),um();else{let e=n.bloomLevel||1;if(r.category===`Paham Konsep`?Z.currentBloomLevel=Math.min(6,e+1):r.category===`Miskonsepsi`&&(Z.currentBloomLevel=Math.max(1,e-1)),r.tier1Correct&&qf(10,`jawaban benar`),r.category===`Miskonsepsi`){Q();let e=n.topic===`Pengaruh Tekanan dan Volume`?`misi2`:`misi1`;$f(` AI Mendeteksi Miskonsepsi!`,`<div style="font-size:13px;line-height:1.6;">
    ...
    `);let t={userId:`student123`,timestamp:new Date().toISOString(),totalTimeTaken:600-Z.quizTimeLeft,results:Z.quizResults.map(e=>({topic:e.topic,bloomLevel:e.bloomLevel,tier1Answer:e.tier1Answer,tier1Correct:e.tier1Correct,tier2Confidence:e.tier2Confidence,tier3Answer:e.tier3Answer,tier3Correct:e.tier3Correct,tier4Confidence:e.tier4Confidence,category:e.category,timeTaken:e.timeTaken}))};try{let e=await Fp(t);Z.aiRecommendations=e.analysis.recommendations,Z.aiClassification=e.analysis.classification,Z.aiAnalysisHistory=Z.aiAnalysisHistory||[],Z.aiAnalysisHistory.push({date:new Date().toISOString(),payload:t,analysis:e.analysis})}catch(e){console.warn(`AI Fallback triggered:`,e),Z.aiRecommendations=Xf(Z.quizResults),Z.aiClassification=`Analisis AI Tidak Tersedia (Fallback)`,zf(`Gagal terhubung ke AI, menggunakan analisis standar.`)}let n=Z.quizResults.filter(e=>e.category===`Paham Konsep`).length;n>0&&qf(n*20,`bonus pemahaman`),Q(),Yf(`quiz`),Vf(`studentResult`)}function Lp(){clearInterval(If),If=null,Z.currentSetIndex=0,Z.currentTier=1,Z.currentBloomLevel=1,Z.quizResults=[],Z.aiRecommendations=[],Q(),Vf(`studentQuiz`)}function Rp(){let e=Z.quizResults,t=e.length,n=e.filter(e=>e.tier1Correct).length,r=t?Math.round(n/t*100):0,i=2*Math.PI*45,a=i-r/100*i,o=600-Z.quizTimeLeft,s=Math.floor(o/60),c=o%60,l=e.filter(e=>e.category===`Paham Konsep`).length,u=e.filter(e=>e.category===`Menebak`).length,d=e.filter(e=>e.category===`Miskonsepsi`).length,f=e.filter(e=>e.category===`Tidak Paham`).length,p=Z.aiRecommendations?.length>0,m=e=>`<span class="badge ${{"Paham Konsep":`paham`,Menebak:`menebak`,Miskonsepsi:`miskonsepsi`,"Tidak Paham":`tidak-paham`}[e]||``}" style="font-size:9px;padding:2px 6px;">${{"Paham Konsep":``,Menebak:`️`,Miskonsepsi:``,"Tidak Paham":``}[e]||``} ${$(e||`-`)}</span>`,h=e.map((e,t)=>{let n=wf[e.setIndex];if(!n)return``;let r=e.category===`Miskonsepsi`?`<div class="misconception-detail">️ <b>Letak miskonsepsi:</b> Kamu yakin dengan jawaban yang salah. ${$(n.tier3.options[n.tier3.answer].substring(0,80))}...</div>`:``;return`<div class="result-topic-card">
      ...
      ${r}
    </div>`}).join(``),g=Z.aiClassification&&Z.aiClassification.includes(`Miskonsepsi`)?`#1e1b4b`:`#0f2d1a`,_=Z.aiClassification?`Klasifikasi AI: <b style="color:#2dd4bf;">${$(Z.aiClassification)}</b>`:d>0?`Terdeteksi <b>${d} topik miskonsepsi</b>.`:`Pemahaman kamu sudah baik.`;rp(`${tp({back:!0})}
  ...
  `)}function zp(){let e=(Z.aiRecommendations||[]).filter(e=>e.type===`misi`).map(e=>e.id);!Z.webarMisiAktif&&!Z.webarHookMisi?(rp(`${tp({back:!0,titleBackPage:`studentDashboard`,coins:!1})}<div id="webarContainer"></div>`,{noNav:!0}),bf(document.getElementById(`webarContainer`),e=>{Z.webarHookMisi=e,Q(),um()},e,()=>{window.go(Z.role===`siswa`?Z.joinedClass?`studentDashboard`:`joinClass`:`teacherClasses`)})):Z.webarHookMisi&&!Z.webarMisiAktif?(Nf.innerHTML=``,yf(Nf,Z.webarHookMisi,()=>{Z.webarMisiAktif=Z.webarHookMisi,Z.webarHookMisi=null,Z.viewedMisi||=[],Z.viewedMisi.includes(Z.webarMisiAktif)||Z.viewedMisi.push(Z.webarMisiAktif),Q(),um()})):(Nf.innerHTML=``,xf(Nf,Z.webarMisiAktif,e=>{e?.completed&&(qf(50,`misi WebAR selesai`),Yf(`ar`)),Z.webarMisiAktif=null,Z.webarHookMisi=null,Q(),um()}))}function Bp(){Z.colorblind=!Z.colorblind,document.body.classList.toggle(`colorblind-mode`,Z.colorblind),Q(),um()}function Vp(){rp(`
    ...
    <div style="padding:0 28px;margin-top:20px;"><button class="btn ghost full" onclick="window.showAddClassModal()">+ Buat Kelas Baru</button></div>`,{noNav:!0}),setTimeout(Up,60)}var Hp=0;function Up(){Hp=Z.selectedClassIndex||0,Wp()}function Wp(){let e=document.getElementById(`coverflowTrack`);if(!e)return;let t=e.querySelectorAll(`.coverflow-slide`),n=t.length;t.forEach((e,t)=>{let r=t-Hp;n>2&&(r>Math.floor(n/2)&&(r-=n),r<-Math.floor(n/2)&&(r+=n));let i=Math.abs(r),a=Math.sign(r),o=i===0?1.05:.85,s=i===0?0:a*140;e.style.transform=`translateX(${s}px) scale(${o})`,e.style.zIndex=i===0?100:50,e.style.opacity=i===0?1:.4,e.style.pointerEvents=i===0?`auto`:`none`})}function Gp(e){let t=Z.classes.length;t!==0&&(Hp=(Hp+e+t)%t,Wp())}function Kp(e){Z.selectedClassIndex=e,Q(),Vf(`teacherDashboard`)}function qp(){let e=Uf();rp(`${tp({coins:!1,back:!0,titleBackPage:`teacherClasses`})}
    ...
    </div>`)}function Jp(){$f(`Buat Kelas Baru`,`<div class="field"><label>Nama Kelas Baru</label><input id="newClassName" class="input" placeholder="Contoh: XI IPA 4"></div>`,`<button class="btn full" onclick="window.addClass()">Buat Kelas</button><button class="btn ghost full" onclick="window.closeModal()">Batal</button>`)}function Yp(){let e=document.getElementById(`newClassName`).value.trim();if(!e)return zf(`Isi nama kelas!`);let t=`KIM-${Math.floor(140+Math.random()*850)}`;Z.classes.push({id:`c${Date.now()}`,name:e,code:t,students:32,progress:0,quiz:10,roster:[]}),Z.selectedClassIndex=Z.classes.length-1,Q(),ep(),um(),zf(`Kelas baru ${t} aktif! `)}function Xp(){let e=Uf();rp(`${tp({coins:!1,back:!0,titleBackPage:`teacherDashboard`})}
    ...
    <div class="info-list">
      ${e.roster.map(e=>`<div class="card" style="display:flex;justify-content:space-between;align-items:center;padding:12px;margin-bottom:10px;">
        <div style="display:flex;align-items:center;gap:10px;"><span class="avatar-sm">${Cf.user}</span>
    ...
    </div>`)}function Zp(){rp(`${tp({coins:!1,back:!0,titleBackPage:`teacherDashboard`})}
    ...
    <div class="module-list">${Z.modules.map(e=>`<div class="card" style="display:flex;justify-content:space-between;align-items:center;padding:12px;margin-bottom:8px;"><div><b style="font-size:13px">${$(e.title)}</b><div style="margin-top:4px;"><span class="pill ${Sp(e.type)}">${xp(e.type)}</span><span class="pill ai" style="margin-left:4px;"> AI</span></div></div><button class="icon-btn danger" onclick="window.deleteModule('${e.id}')">${Cf.trash}</button></div>`).join(``)}</div>`)}function Qp(){let e=document.getElementById(`moduleTitle`).value.trim(),t=document.getElementById(`moduleSummary`).value.trim(),n=document.getElementById(`moduleType`).value,r=document.getElementById(`moduleDifficulty`).value;if(!e||!t)return zf(`Judul & Deskripsi wajib diisi!`);let i=document.getElementById(`uploadModuleBtn`);i.textContent=` AI sedang membuat ringkasan...`,i.disabled=!0,setTimeout(()=>{let i=[`${t.split(` `).slice(0,4).join(` `)}...`,`Konsep ini berkaitan dengan Asas Le Chatelier.`,`Pelajari persamaan reaksi yang diberikan.`];Z.modules.unshift({id:`m${Date.now()}`,type:n,title:e,meta:`${xp(n)} • Baru ditambahkan`,summary:`[Ringkasan AI] ${t}`,points:i,tips:[`Baca pelan-pelan dan catat kata kunci.`,`Hubungkan dengan simulasi WebAR untuk pemahaman visual.`],difficulty:r,time:`12 Menit`,prereq:`Kesetimbangan Kimia Dasar`}),Q(),zf(` Materi terunggah dengan Ringkasan AI!`),um()},1800)}function $p(e){Z.modules=Z.modules.filter(t=>t.id!==e),Q(),um(),zf(`Modul dihapus.`)}function em(){let e=Z.modules&&Z.modules.length>0,t=``;t=e?`
      <div class="card add-panel" style="margin-bottom: 18px;">
        <h4 style="margin:0 0 12px; display:flex; align-items:center; gap:8px;">
          <span style="background:var(--purple); color:white; padding:4px; border-radius:6px; display:flex;">${Cf.brain}</span>
    ...
    `:`
      <div class="card add-panel" style="margin-bottom: 18px; text-align:center; padding:24px 16px;">
        <div style="color:var(--purple); width:48px; height:48px; margin:0 auto 12px;">${Cf.brain}</div>
    ...
    <div class="card" style="padding:14px;margin-bottom:14px;border-radius:18px;">
      ...
      <div style="display:flex;justify-content:space-between;text-align:center;background:#fbfaff;padding:8px;border-radius:10px;margin-bottom:10px;border:1px solid #f0ecf8;">
        ...
        <div><b style="font-size:15px;display:block;">${Uf().students}</b><span class="small muted">belum</span></div>
  ...
  `).join(``);rp(`${tp({coins:!1,back:!0,titleBackPage:`teacherDashboard`})}
    ...
    </div>`)}function tm(){Z.teacherEditingQuestionId=null,Q(),Vf(`teacherEditQuiz`)}function nm(e){Z.teacherEditingQuestionId=e,Q(),Vf(`teacherEditQuiz`)}function rm(){let e=Z.teacherEditingQuestionId!==null,t={question:``,type:``,tier:1,optA:``,optB:``,optC:``,optD:``,ans:0};if(e){let e=Z.questions.find(e=>e.id===Z.teacherEditingQuestionId)||Z.questions[0];t={question:e.question,type:e.type,tier:e.tier,optA:e.options[0]||``,optB:e.options[1]||``,optC:e.options[2]||``,optD:e.options[3]||``,ans:e.answer}}rp(`${tp({back:!0,titleBackPage:`teacherQuiz`,coins:!1})}
    ...
    </div>`)}function im(){let e=document.getElementById(`qType`).value.trim(),t=parseInt(document.getElementById(`qTier`).value),n=document.getElementById(`qText`).value.trim(),r=[0,1,2,3].map(e=>document.getElementById(`qOpt${e}`).value.trim()),i=parseInt(document.getElementById(`qAns`).value);if(!e||!n||!r[0]||!r[1])return zf(`Mohon lengkapi parameter soal!`);if(Z.teacherEditingQuestionId!==null){let a=Z.questions.findIndex(e=>e.id===Z.teacherEditingQuestionId);a>=0&&(Z.questions[a]={id:Z.teacherEditingQuestionId,tier:t,type:e,question:n,options:r,answer:i,reason:``})}else Z.questions.unshift({id:`q_${Date.now()}`,tier:t,type:e,question:n,options:r,answer:i,reason:``});Q(),zf(`Bank soal berhasil diperbarui!`),Vf(`teacherQuiz`)}function am(){let e=Uf(),t=e.roster||[],n=t.length||1,r=t.filter(e=>e.category===`Paham Konsep`).length,i=t.filter(e=>e.category===`Menebak`).length,a=t.filter(e=>e.category===`Miskonsepsi`).length,o=Math.round(r/n*100),s=Math.round(i/n*100),c=Math.round(a/n*100),l=Object.keys(Tf).map(e=>{let r=t.filter(t=>t.category===`Miskonsepsi`&&(t.topics||[]).includes(e)).length,i=t.filter(t=>t.category===`Menebak`&&(t.topics||[]).includes(e)).length,a=n-r-i;return{topic:e,misk:r,menebak:i,paham:a,miskPct:Math.round(r/n*100),menebakPct:Math.round(i/n*100),pahamPct:Math.round(a/n*100)}}).sort((e,t)=>e.pahamPct-t.pahamPct);rp(`${tp({back:!0,titleBackPage:`teacherDashboard`,coins:!1})}
    ...
    <div class="card" style="margin-bottom:14px;">
      ...
      ${c.map(e=>`
        <div class="student-row" style="margin-bottom:8px; background:${e.topicStat===`Miskonsepsi`?`rgba(239, 68, 68, 0.05)`:`rgba(245, 158, 11, 0.05)`}; border:1px solid ${e.topicStat===`Miskonsepsi`?`rgba(239, 68, 68, 0.2)`:`rgba(245, 158, 11, 0.2)`};">
          <div style="display:flex;align-items:center;gap:8px;">
            <span class="avatar-sm">${Cf.user}</span>
      ...
      ${l.map(e=>`
        <div class="student-row" style="margin-bottom:8px;">
          <div style="display:flex;align-items:center;gap:8px;">
            <span class="avatar-sm" style="background:#f0f9ff; color:#0ea5e9;">${Cf.user}</span>
            <b style="font-size:13px">${$(e.name)}</b>
          </div>
          <span class="badge" style="background:rgba(16, 185, 129, 0.1); color:#10b981;">Paham Konsep</span>
        </div>`).join(``)}
    </div>
  `)}function sm(){if(typeof html2pdf>`u`){zf(` Library PDF belum dimuat.`);return}let e=document.getElementById(`area-cetak-laporan`),t=Z.classes[Z.selectedClassIndex]?.name||`Kelas`;zf(` Memproses PDF...`);let n=e.querySelectorAll(`.pdf-only-section`);n.forEach(e=>e.style.display=`block`);let r={margin:[15,12,15,12],filename:`Laporan_ARChemy_${t}.pdf`,image:{type:`jpeg`,quality:.98},html2canvas:{scale:2,useCORS:!0,logging:!1},jsPDF:{unit:`mm`,format:`a4`,orientation:`portrait`}};try{html2pdf().set(r).from(e).save().then(()=>{zf(`PDF Berhasil diunduh!`),n.forEach(e=>e.style.display=`none`)}).catch(()=>{zf(`Gagal ekspor PDF.`),n.forEach(e=>e.style.display=`none`)})}catch(e){zf(`Gagal: `+e.message),n.forEach(e=>e.style.display=`none`)}}function cm(){let e=Hf(),t=(Z.badges||[]).map(e=>Af[e]?`<div class="badge-card"><span class="badge-emoji">${Af[e].emoji}</span><div><b>${Af[e].name}</b><span class="small muted" style="display:block">${Af[e].desc}</span></div></div>`:``).join(``);rp(`${tp({back:!0,titleBackPage:Z.role===`siswa`?`studentDashboard`:`teacherDashboard`,coins:Z.role===`siswa`})}
    ...
    <div class="card info-list" style="margin-top:14px;">
      ...
      <div class="info-row" style="cursor:pointer;" onclick="window.toggleColorblind()"><b>Mode Buta Warna</b><span>${Z.colorblind?` Aktif`:`Nonaktif`}</span></div>
    </div>
    ${Z.role===`siswa`&&(Z.badges||[]).length>0?`
    <h3 class="section-title">Badge Kamu </h3>
    <div class="card">${t}</div>`:``}
    <div class="actions-row" style="margin-top:14px;"><button class="btn danger full" onclick="window.logout()">Logout Akun</button></div>`)}function lm(e){return(e||``).split(` `)[0]||`User`}function $(e){return String(e??``).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#039;`})[e])}function um(){let e={login:ip,register:op,joinClass:cp,studentDashboard:dp,studentModules:_p,studentQuiz:kp,studentQuizPage:Ap,studentResult:Rp,studentWebAR:zp,studentAdaptivePath:mp,teacherClasses:Vp,teacherDashboard:qp,teacherModules:Zp,teacherQuiz:em,teacherEditQuiz:rm,teacherAnalysis:am,teacherTopicDetail:om,profile:cm,teacherClassDetail:Xp};try{(e[Z.page]||ip)()}catch(e){console.error(`[ARChemy Render Error]`,e),Nf.innerHTML=`<section class="screen" style="text-align:center;padding-top:80px;"><h2 style="color:var(--danger);">Terjadi Kesalahan</h2><p class="muted" style="font-size:13px;">${$(e.message)}</p><button class="btn" style="margin-top:16px;" onclick="window.state.page='login';window.render();">Kembali ke Login</button><button class="btn ghost" style="margin-top:8px;" onclick="localStorage.removeItem('archemyState');location.reload();">Reset Data</button></section>`}}typeof window<`u`&&(window.state=Z,window.saveState=Q,window.toast=zf,window.go=Vf,window.goHome=Gf,window.setRole=Bf,window.logout=Rf,window.closeModal=ep,window.submitLogin=ap,window.submitRegister=sp,window.fillCode=lp,window.joinClass=up,window.setModuleFilter=yp,window.openModule=wp,window.closeModule=Tp,window.openModuleFromPath=hp,window.goToMisi=gp,window.startQuiz=Dp,window.selectOption=jp,window.selectConfidence=Mp,window.saveAndNext=Np,window.resetQuiz=Lp,window.jalankanLompatanAdaptif=Pp,window.executeQuizEnd=Ip,window.toggleColorblind=Bp,window.moveCoverflow=Gp,window.selectCoverflowClass=Kp,window.showAddClassModal=Jp,window.addClass=Yp,window.addModuleWithAI=Qp,window.deleteModule=$p,window.newQuestion=tm,window.saveQuestion=im,window.eksporLaporanPDF=sm,window.editQuestion=nm,window.teacherTopicDetail=e=>{Z.activeTopic=e,Vf(`teacherTopicDetail`)},window.render=um),um();