...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ia(e,t,n){let r=new Float32Array(Sa),i=new G(0,1,0);return new oi({name:`SphericalGaussianBlur`,defines:{n:Sa,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:za(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function La(){return new oi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:za(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ra(){return new oi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:za(),fragmentShader:`
	...
	`}var Ba=class extends Dt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Hr(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),u=new Ar(c,l),d=new Vi(-1,1,1,-1,0,1),f=null,p=null,m=!1,h,_=null,v=[],y=!1;this.setSize=function(e,t){o.setSize(e,t),s.setSize(e,t);for(let n=0;n<v.length;n++){let r=v[n];r.setSize&&r.setSize(e,t)}},this.setEffects=function(e){v=e,y=v.length>0&&v[0].isRenderPass===!0;let t=o.width,n=o.height;for(let e=0;e<v.length;e++){let r=v[e];r.setSize&&r.setSize(t,n)}},this.begin=function(e,t){if(m||e.toneMapping===0&&v.length===0)return!1;if(_=t,t!==null){let e=t.width,n=t.height;(o.width!==e||o.height!==n)&&this.setSize(e,n)}return y===!1&&e.setRenderTarget(o),h=e.toneMapping,e.toneMapping=0,!0},this.hasRenderPass=function(){return y},this.end=function(e,t){e.toneMapping=h,m=!0;let n=o,r=s;for(let i=0;i<v.length;i++){let a=v[i];if(a.enabled!==!1&&(a.render(e,r,n,t),a.needsSwap!==!1)){let e=n;n=r,r=e}}if(f!==e.outputColorSpace||p!==e.toneMapping){f=e.outputColorSpace,p=e.toneMapping,l.defines={},q.getTransfer(f)===`srgb`&&(l.defines.SRGB_TRANSFER=``);let t=Ja[p];t&&(l.defines[t]=``),l.needsUpdate=!0}l.uniforms.tDiffuse.value=n.texture,e.setRenderTarget(_),e.render(u,d),_=null,m=!1},this.isCompositing=function(){return m},this.dispose=function(){o.depthTexture&&o.depthTexture.dispose(),o.dispose(),s.dispose(),c.dispose(),l.dispose()}}var Xa=new wt,Za=new Ur(1,1),Qa=new Ot,$a=new kt,eo=new Hr,to=[],no=[],ro=new Float32Array(16),io=new Float32Array(9),ao=new Float32Array(4);function oo(e,t,n){let r=e[0];if(r<=0||r>0)return e;let i=t*n,a=to[i];if(a===void 0&&(a=new Float32Array(i),to[i]=a),t!==0){r.toArray(a,0);for(let r=1,i=0;r!==t;++r)i+=n,e[r].toArray(a,i)}return a}function so(e,t){if(e.length!==t.length)return!1;for(let n=0,r=e.length;n<r;n++)if(e[n]!==t[n])return!1;return!0}function co(e,t){for(let n=0,r=t.length;n<r;n++)e[n]=t[n]}function lo(e,t){let n=no[t];n===void 0&&(n=new Int32Array(t),no[t]=n);for(let r=0;r!==t;++r)n[r]=e.allocateTextureUnit();return n}function uo(e,t){let n=this.cache;n[0]!==t&&(e.uniform1f(this.addr,t),n[0]=t)}function fo(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y)&&(e.uniform2f(this.addr,t.x,t.y),n[0]=t.x,n[1]=t.y);else{if(so(n,t))return;e.uniform2fv(this.addr,t),co(n,t)}}function po(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z)&&(e.uniform3f(this.addr,t.x,t.y,t.z),n[0]=t.x,n[1]=t.y,n[2]=t.z);else if(t.r!==void 0)(n[0]!==t.r||n[1]!==t.g||n[2]!==t.b)&&(e.uniform3f(this.addr,t.r,t.g,t.b),n[0]=t.r,n[1]=t.g,n[2]=t.b);else{if(so(n,t))return;e.uniform3fv(this.addr,t),co(n,t)}}function mo(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z||n[3]!==t.w)&&(e.uniform4f(this.addr,t.x,t.y,t.z,t.w),n[0]=t.x,n[1]=t.y,n[2]=t.z,n[3]=t.w);else{if(so(n,t))return;e.uniform4fv(this.addr,t),co(n,t)}}function ho(e,t){let n=this.cache,r=t.elements;if(r===void 0){if(so(n,t))return;e.uniformMatrix2fv(this.addr,!1,t),co(n,t)}else{if(so(n,r))return;ao.set(r),e.uniformMatrix2fv(this.addr,!1,ao),co(n,r)}}function go(e,t){let n=this.cache,r=t.elements;if(r===void 0){if(so(n,t))return;e.uniformMatrix3fv(this.addr,!1,t),co(n,t)}else{if(so(n,r))return;io.set(r),e.uniformMatrix3fv(this.addr,!1,io),co(n,r)}}function _o(e,t){let n=this.cache,r=t.elements;if(r===void 0){if(so(n,t))return;e.uniformMatrix4fv(this.addr,!1,t),co(n,t)}else{if(so(n,r))return;ro.set(r),e.uniformMatrix4fv(this.addr,!1,ro),co(n,r)}}function vo(e,t){let n=this.cache;n[0]!==t&&(e.uniform1i(this.addr,t),n[0]=t)}function yo(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y)&&(e.uniform2i(this.addr,t.x,t.y),n[0]=t.x,n[1]=t.y);else{if(so(n,t))return;e.uniform2iv(this.addr,t),co(n,t)}}function bo(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z)&&(e.uniform3i(this.addr,t.x,t.y,t.z),n[0]=t.x,n[1]=t.y,n[2]=t.z);else{if(so(n,t))return;e.uniform3iv(this.addr,t),co(n,t)}}function xo(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z||n[3]!==t.w)&&(e.uniform4i(this.addr,t.x,t.y,t.z,t.w),n[0]=t.x,n[1]=t.y,n[2]=t.z,n[3]=t.w);else{if(so(n,t))return;e.uniform4iv(this.addr,t),co(n,t)}}function So(e,t){let n=this.cache;n[0]!==t&&(e.uniform1ui(this.addr,t),n[0]=t)}function Co(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y)&&(e.uniform2ui(this.addr,t.x,t.y),n[0]=t.x,n[1]=t.y);else{if(so(n,t))return;e.uniform2uiv(this.addr,t),co(n,t)}}function wo(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z)&&(e.uniform3ui(this.addr,t.x,t.y,t.z),n[0]=t.x,n[1]=t.y,n[2]=t.z);else{if(so(n,t))return;e.uniform3uiv(this.addr,t),co(n,t)}}function To(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z||n[3]!==t.w)&&(e.uniform4ui(this.addr,t.x,t.y,t.z,t.w),n[0]=t.x,n[1]=t.y,n[2]=t.z,n[3]=t.w);else{if(so(n,t))return;e.uniform4uiv(this.addr,t),co(n,t)}}function Eo(e,t,n){let r=this.cache,i=n.allocateTextureUnit();r[0]!==i&&(e.uniform1i(this.addr,i),r[0]=i);let a;this.type===e.SAMPLER_2D_SHADOW?(Za.compareFunction=n.isReversedDepthBuffer()?518:515,a=Za):a=Xa,n.setTexture2D(t||a,i)}function Do(e,t,n){let r=this.cache,i=n.allocateTextureUnit();r[0]!==i&&(e.uniform1i(this.addr,i),r[0]=i),n.setTexture3D(t||$a,i)}function Oo(e,t,n){let r=this.cache,i=n.allocateTextureUnit();r[0]!==i&&(e.uniform1i(this.addr,i),r[0]=i),n.setTextureCube(t||eo,i)}function ko(e,t,n){let r=this.cache,i=n.allocateTextureUnit();r[0]!==i&&(e.uniform1i(this.addr,i),r[0]=i),n.setTexture2DArray(t||Qa,i)}function Ao(e){switch(e){case 5126:return uo;case 35664:return fo;case 35665:return po;case 35666:return mo;case 35674:return ho;case 35675:return go;case 35676:return _o;case 5124:case 35670:return vo;case 35667:case 35671:return yo;case 35668:case 35672:return bo;case 35669:case 35673:return xo;case 5125:return So;case 36294:return Co;case 36295:return wo;case 36296:return To;case 35678:case 36198:case 36298:case 36306:case 35682:return Eo;case 35679:case 36299:case 36307:return Do;case 35680:case 36300:case 36308:case 36293:return Oo;case 36289:case 36303:case 36311:case 36292:return ko}}function jo(e,t){e.uniform1fv(this.addr,t)}function Mo(e,t){let n=oo(t,this.size,2);e.uniform2fv(this.addr,n)}function No(e,t){let n=oo(t,this.size,3);e.uniform3fv(this.addr,n)}function Po(e,t){let n=oo(t,this.size,4);e.uniform4fv(this.addr,n)}function Fo(e,t){let n=oo(t,this.size,4);e.uniformMatrix2fv(this.addr,!1,n)}function Io(e,t){let n=oo(t,this.size,9);e.uniformMatrix3fv(this.addr,!1,n)}function Lo(e,t){let n=oo(t,this.size,16);e.uniformMatrix4fv(this.addr,!1,n)}function Ro(e,t){e.uniform1iv(this.addr,t)}function zo(e,t){e.uniform2iv(this.addr,t)}function Bo(e,t){e.uniform3iv(this.addr,t)}function Vo(e,t){e.uniform4iv(this.addr,t)}function Ho(e,t){e.uniform1uiv(this.addr,t)}function Uo(e,t){e.uniform2uiv(this.addr,t)}function Wo(e,t){e.uniform3uiv(this.addr,t)}function Go(e,t){e.uniform4uiv(this.addr,t)}function Ko(e,t,n){let r=this.cache,i=t.length,a=lo(n,i);so(r,a)||(e.uniform1iv(this.addr,a),co(r,a));let o;o=this.type===e.SAMPLER_2D_SHADOW?Za:Xa;for(let e=0;e!==i;++e)n.setTexture2D(t[e]||o,a[e])}function qo(e,t,n){let r=this.cache,i=t.length,a=lo(n,i);so(r,a)||(e.uniform1iv(this.addr,a),co(r,a));for(let e=0;e!==i;++e)n.setTexture3D(t[e]||$a,a[e])}function Jo(e,t,n){let r=this.cache,i=t.length,a=lo(n,i);so(r,a)||(e.uniform1iv(this.addr,a),co(r,a));for(let e=0;e!==i;++e)n.setTextureCube(t[e]||eo,a[e])}function Yo(e,t,n){let r=this.cache,i=t.length,a=lo(n,i);so(r,a)||(e.uniform1iv(this.addr,a),co(r,a));for(let e=0;e!==i;++e)n.setTexture2DArray(t[e]||Qa,a[e])}function Xo(e){switch(e){case 5126:return jo;case 35664:return Mo;case 35665:return No;case 35666:return Po;case 35674:return Fo;case 35675:return Io;case 35676:return Lo;case 5124:case 35670:return Ro;case 35667:case 35671:return zo;case 35668:case 35672:return Bo;case 35669:case 35673:return Vo;case 5125:return Ho;case 36294:return Uo;case 36295:return Wo;case 36296:return Go;case 35678:case 36198:case 36298:case 36306:case 35682:return Ko;case 35679:case 36299:case 36307:return qo;case 35680:case 36300:case 36308:case 36293:return Jo;case 36289:case 36303:case 36311:case 36292:return Yo}}var Zo=class{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=Ao(t.type)}},Qo=class{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Xo(t.type)}},$o=class{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){let r=this.seq;for(let i=0,a=r.length;i!==a;++i){let a=r[i];a.setValue(e,t[a.id],n)}}},es=/(\w+)(\])?(\[|\.)?/g;function ts(e,t){e.seq.push(t),e.map[t.id]=t}function ns(e,t,n){let r=e.name,i=r.length;for(es.lastIndex=0;;){let a=es.exec(r),o=es.lastIndex,s=a[1],c=a[2]===`]`,l=a[3];if(c&&(s|=0),l===void 0||l===`[`&&o+2===i){ts(n,l===void 0?new Zo(s,e,t):new Qo(s,e,t));break}else{let e=n.map[s];e===void 0&&(e=new $o(s),ts(n,e)),n=e}}}var rs=class{constructor(e,t){this.seq=[],this.map={};let n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){let n=e.getActiveUniform(t,r);ns(n,e.getUniformLocation(t,n.name),this)}let r=[],i=[];for(let t of this.seq)t.type===e.SAMPLER_2D_SHADOW||t.type===e.SAMPLER_CUBE_SHADOW||t.type===e.SAMPLER_2D_ARRAY_SHADOW?r.push(t):i.push(t);r.length>0&&(this.seq=r.concat(i))}setValue(e,t,n,r){let i=this.map[t];i!==void 0&&i.setValue(e,n,r)}setOptional(e,t,n){let r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let i=0,a=t.length;i!==a;++i){let a=t[i],o=n[a.id];o.needsUpdate!==!1&&a.setValue(e,o.value,r)}}static seqWithValue(e,t){let n=[];for(let r=0,i=e.length;r!==i;++r){let i=e[r];i.id in t&&n.push(i)}return n}};function is(e,t,n){let r=e.createShader(t);return e.shaderSource(r,n),e.compileShader(r),r}var as=37297,os=0;function ss(e,t){let n=e.split(`
`),r=[],i=Math.max(t-6,0),a=Math.min(t+6,n.length);for(let e=i;e<a;e++){let i=e+1;r.push(`${i===t?`>`:` `} ${i}: ${n[e]}`)}return r.join(`
`)}var cs=new K;function ls(e){q._getMatrix(cs,q.workingColorSpace,e);let t=`mat3( ${cs.elements.map(e=>e.toFixed(4))} )`;switch(q.getTransfer(e)){case Le:return[t,`LinearTransferOETF`];case Re:return[t,`sRGBTransferOETF`];default:return V(`WebGLProgram: Unsupported color space: `,e),[t,`LinearTransferOETF`]}}function us(e,t,n){let r=e.getShaderParameter(t,e.COMPILE_STATUS),i=(e.getShaderInfoLog(t)||``).trim();if(r&&i===``)return``;let a=/ERROR: 0:(\d+)/.exec(i);if(a){let r=parseInt(a[1]);return n.toUpperCase()+`

`+i+`

`+ss(e.getShaderSource(t),r)}else return i}function ds(e,t){let n=ls(t);return[`vec4 ${e}( vec4 value ) {`,`	return ${n[1]}( vec4( value.rgb * ${n[0]}, value.a ) );`,`}`].join(`
`)}var fs={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function ps(e,t){let n=fs[t];return n===void 0?(V(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var ms=new G;function hs(){return q.getLuminanceCoefficients(ms),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${ms.x.toFixed(4)}, ${ms.y.toFixed(4)}, ${ms.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
`)}function gs(e){return[e.extensionClipCullDistance?`#extension GL_ANGLE_clip_cull_distance : require`:``,e.extensionMultiDraw?`#extension GL_ANGLE_multi_draw : require`:``].filter(ys).join(`
`)}function _s(e){let t=[];for(let n in e){let r=e[n];r!==!1&&t.push(`#define `+n+` `+r)}return t.join(`
`)}function vs(e,t){let n={},r=e.getProgramParameter(t,e.ACTIVE_ATTRIBUTES);for(let i=0;i<r;i++){let r=e.getActiveAttrib(t,i),a=r.name,o=1;r.type===e.FLOAT_MAT2&&(o=2),r.type===e.FLOAT_MAT3&&(o=3),r.type===e.FLOAT_MAT4&&(o=4),n[a]={type:r.type,location:e.getAttribLocation(t,a),locationSize:o}}return n}function ys(e){return e!==``}function bs(e,t){let n=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return e.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,n).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function xs(e,t){return e.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}var Ss=/^[ \t]*#include +<([\w\d./]+)>/gm;function Cs(e){return e.replace(Ss,Ts)}var ws=new Map;function Ts(e,t){let n=Y[t];if(n===void 0){let e=ws.get(t);if(e!==void 0)n=Y[e],V(`WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.`,t,e);else throw Error(`THREE.WebGLProgram: Can not resolve #include <`+t+`>`)}return Cs(n)}var Es=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Ds(e){return e.replace(Es,Os)}function Os(e,t,n,r){let i=``;for(let e=parseInt(t);e<parseInt(n);e++)i+=r.replace(/\[\s*i\s*\]/g,`[ `+e+` ]`).replace(/UNROLLED_LOOP_INDEX/g,e);return i}function ks(e){let t=`precision ${e.precision} float;
...
#define LOW_PRECISION`),t}var As={1:`SHADOWMAP_TYPE_PCF`,3:`SHADOWMAP_TYPE_VSM`};function js(e){return As[e.shadowMapType]||`SHADOWMAP_TYPE_BASIC`}var Ms={301:`ENVMAP_TYPE_CUBE`,302:`ENVMAP_TYPE_CUBE`,306:`ENVMAP_TYPE_CUBE_UV`};function Ns(e){return e.envMap===!1?`ENVMAP_TYPE_CUBE`:Ms[e.envMapMode]||`ENVMAP_TYPE_CUBE`}var Ps={302:`ENVMAP_MODE_REFRACTION`};function Fs(e){return e.envMap===!1?`ENVMAP_MODE_REFLECTION`:Ps[e.envMapMode]||`ENVMAP_MODE_REFLECTION`}var Is={0:`ENVMAP_BLENDING_MULTIPLY`,1:`ENVMAP_BLENDING_MIX`,2:`ENVMAP_BLENDING_ADD`};function Ls(e){return e.envMap===!1?`ENVMAP_BLENDING_NONE`:Is[e.combine]||`ENVMAP_BLENDING_NONE`}function Rs(e){let t=e.envMapCubeUVHeight;if(t===null)return null;let n=Math.log2(t)-2,r=1/t;return{texelWidth:1/(3*Math.max(2**n,112)),texelHeight:r,maxMip:n}}function zs(e,t,n,r){let i=e.getContext(),a=n.defines,o=n.vertexShader,s=n.fragmentShader,c=js(n),l=Ns(n),u=Fs(n),d=Ls(n),f=Rs(n),p=gs(n),m=_s(a),h=i.createProgram(),g,_,v=n.glslVersion?`#version `+n.glslVersion+`
...
void main() {
    ...
    <div class="webar-pilih-misi">
      ...
      <div class="misi-grid">${Object.entries(Ec).map(([e,t])=>`
      <button class="misi-card" data-misi="${e}">
        <h3 class="misi-judul">${t.judul}</h3>
        <code class="misi-persamaan">${t.persamaan}</code>
      </button>`).join(``)}</div>
    </div>`,e.querySelectorAll(`.misi-card`).forEach(e=>{e.addEventListener(`click`,()=>t(e.dataset.misi))})}async function Wc(e,t,n){let r=Ec[t];if(!r)return;e.innerHTML=`
    ...
    </div>`;let i=e.querySelector(`#webarStatus`),a=e.querySelector(`#webarCanvas`),o=e.querySelector(`#webarVideo`),s=e.querySelector(`#webarTapHint`),c=e.querySelector(`#webarControls`);if(e.querySelector(`#webarKeluar`).addEventListener(`click`,()=>{Jc(),n()}),Hc=await kc(),Hc===`unsupported`){i.textContent=`Perangkat tidak mendukung kamera. Coba buka di HP dengan kamera belakang.`;return}Gc(a);let l=()=>{let e=document.getElementById(`slider-suhu`);return e?Number(e.value)/40:1};try{Hc===`webxr`?(i.textContent=`Mode AR penuh aktif — arahkan ke permukaan datar.`,s.style.display=`block`,Vc=await Rc(a,t,()=>{s.style.display=`none`},l)):(i.textContent=`Mode kamera sederhana aktif (perangkat tidak mendukung AR penuh).`,o.style.display=`block`,Vc=await zc(a,o,t,l)),setTimeout(()=>{i&&(i.style.opacity=`0`)},2500)}catch(e){i.textContent=`Gagal mengakses kamera. Periksa izin kamera pada browser.`,console.error(`[ARChemy WebAR]`,e);return}Kc(c,t)}function Gc(e){let t=e.parentElement.getBoundingClientRect();e.width=t.width,e.height=t.height}function Kc(e,t){let n=Ec[t],r=[{id:`suhu`,icon:`🌡️`,label:`Suhu`},{id:`volume`,icon:`📦`,label:`Volume`},{id:`tekanan`,icon:`🗜️`,label:`Tekanan`},{id:`konsentrasi`,icon:`🧪`,label:`Konsentrasi`}],i=`<div class="webar-tabs">`;r.forEach((e,t)=>{i+=`<button class="webar-tab-btn ${t===0?`active`:``}" data-tab="${e.id}">${e.icon} ${e.label}</button>`}),i+=`</div>`;let a=`<div class="webar-sliders-container">`;r.forEach((e,t)=>{let r=n.rentang[e.id];a+=`
  ...
  </div>`}function bl(){if(!fl())return``;let e=Z.role===`siswa`?[[`studentDashboard`,Yc.home,`Beranda`],[`studentQuiz`,Yc.checklist,`Kuis`],[`studentWebAR`,Yc.ar,`WebAR`],[`studentModules`,Yc.book,`Modul`]]:[[`teacherDashboard`,Yc.home,`Dasbor`],[`teacherQuiz`,Yc.checklist,`Kuis`],[`teacherModules`,Yc.book,`Modul`]];return`<nav class="bottom-nav ${Z.role===`guru`?`three-items`:``}">${e.map(([e,t,n])=>`<button class="nav-item ${Z.page===e?`active`:``}" onclick="window.go('${e}')" aria-label="${n}">${t}</button>`).join(``)}</nav>`}function xl(e,t={}){nl.innerHTML=`<section class="screen ${t.noNav?`no-nav`:``}">${e}</section>${bl()}`,document.body.classList.toggle(`colorblind`,Z.colorblind)}function Sl(){nl.innerHTML=`<section class="auth-screen">
    ...
    <div class="card auth-card">
      ...
      <div class="field"><label>Email</label><input id="loginEmail" class="input" value="${ul().email}" placeholder="email@archemy.id"></div>
      <div class="field"><label>Password</label><input id="loginPass" class="input" type="password" value="${ul().password}" placeholder="Masukkan password"></div>
    ...
    </div></section>`}function Cl(){let e=document.getElementById(`loginEmail`).value.trim();if(!e)return sl(`Email tidak boleh kosong`);Z.profile[Z.role].email=e,Q(),sl(`Login berhasil`),Z.role===`siswa`?ll(Z.joinedClass?`studentDashboard`:`joinClass`):ll(`teacherClasses`)}function wl(){nl.innerHTML=`<section class="auth-screen">
    ...
    <div class="card auth-card">
      ...
      <div class="field"><label>Nama lengkap</label><input id="regName" class="input" value="${ul().name}" placeholder="Nama lengkap"></div>
      <div class="field"><label>Email</label><input id="regEmail" class="input" value="${ul().email}" placeholder="email@archemy.id"></div>
      <div class="field"><label>Sekolah</label><input id="regSchool" class="input" value="${ul().school}" placeholder="Nama sekolah"></div>
      <div class="field"><label>Password</label><input id="regPass" class="input" type="password" value="${ul().password}" placeholder="Buat password"></div>
    ...
    </div></section>`}function Tl(){let e=Z.profile[Z.role];e.name=document.getElementById(`regName`).value.trim()||e.name,e.email=document.getElementById(`regEmail`).value.trim()||e.email,e.school=document.getElementById(`regSchool`).value.trim()||e.school,e.password=document.getElementById(`regPass`).value.trim()||e.password,Q(),sl(`Akun berhasil dibuat`),Z.role===`siswa`?ll(`joinClass`):ll(`teacherClasses`)}function El(){xl(`${yl({coins:!1})}
    ...
    <div class="card"><div class="field"><label>Kode kelas</label><input id="classCode" class="input" placeholder="Contoh: KIM-137"></div><button class="btn full" onclick="window.joinClass()">Gabung Kelas</button></div>`,{noNav:!0})}function Dl(){document.getElementById(`classCode`).value=`KIM-137`}function Ol(){let e=document.getElementById(`classCode`).value.trim().toUpperCase(),t=Z.classes.find(t=>t.code===e);if(!t)return sl(`Kode kelas belum ditemukan`);Z.joinedClass=!0,Z.profile.siswa.className=t.name,Z.selectedClassIndex=Z.classes.indexOf(t),Q(),sl(`Berhasil bergabung ke ${t.name}`),ll(`studentDashboard`)}function kl(){let e=Z.profile.siswa;xl(`${yl()}
    <h1 class="page-title">Halo ${wu(e.name)}!</h1><p class="page-subtitle">Siap berpetualang bersama Chemy?</p>
    ...
    <div class="card activity-card"><div class="flask"></div><div><h3 style="margin:0 0 12px">Progres Aktivitas</h3>${jl(`Modul yang sudah dipelajari`,20)}${jl(`Kuis yang sudah dikerjakan`,10)}${jl(`WebAR yang sudah disimulasikan`,40)}</div></div>
    <div class="card activity-card"><div class="flask"></div><div><h3 style="margin:0 0 12px">Kemampuan</h3>${jl(`Pemahaman baik`,60)}${jl(`Pemahaman kurang`,40)}<button class="btn small-btn" style="float:right;margin-top:8px" onclick="window.go('studentResult')">Lihat detail</button></div></div>
    <section class="leaderboard-wrap"><div class="podium">${Al(`Tiara Yanti`,`first`)}${Al(`Joshua Den`,`second`)}${Al(`Ambar`,`third`)}<div class="podium-number">1</div></div><div class="rank-list">${[`Suci Ramadhani`,`Rafa Pratama`,`Nabila Putri`,`Dimas Arga`,`Intan Maulida`].map((e,t)=>`<div class="rank-row"><span>${t+4}.</span><span class="avatar-sm">${Yc.user}</span><span>${e}</span></div>`).join(``)}</div></section>`)}function Al(e,t){return`<div class="podium-user ${t}"><div class="avatar">${Yc.user}</div><b>${e}</b></div>`}function jl(e,t,n=``){return`<div class="progress-row"><span class="label">${e}</span><span class="pct">${t}%</span><div class="bar"><div class="bar-fill ${n}" style="--w:${t}%"></div></div></div>`}function Ml(){let e=Z.activeModuleFilter,t=Z.modules.filter(t=>e===`all`||t.type===e);xl(`${yl()}<h1 class="page-title">Modul Pembelajaran</h1><div class="tabs">${Nl(`all`,`Semua`)}${Nl(`file`,`File`)}${Nl(`video`,`Video`)}${Nl(`link`,`Link`)}</div><div class="module-list">${t.map(Rl).join(``)||`<div class="empty-state">Belum ada modul.</div>`}</div>${Z.activeModule?Vl(Z.modules.find(e=>e.id===Z.activeModule)):``}`)}function Nl(e,t){return`<button class="tab ${Z.activeModuleFilter===e?`active`:``}" onclick="window.setModuleFilter('${e}')">${t}</button>`}function Pl(e){Z.activeModuleFilter=e,Z.activeModule=null,Q(),Tu()}function Fl(e){return e===`video`?`<div class="module-icon video">${Yc.play}</div>`:e===`link`?`<div class="module-icon link">${Yc.link}</div>`:`<div class="module-icon">${Yc.file}</div>`}function Il(e){return e===`file`?`Dokumen`:e===`video`?`Video`:`Link`}function Ll(e){return e===`file`?`type-doc`:e===`video`?`type-video`:`type-link`}function Rl(e){return`<button class="module-card fold" onclick="window.openModule('${e.id}')"><div class="module-icon-wrap">${Fl(e.type)}</div><h3 class="module-title">${$(e.title)}</h3><div class="module-meta"><span class="pill ${Ll(e.type)}">${Il(e.type)}</span><span class="pill ai">✦ Ringkasan AI</span></div></button>`}function zl(e){Z.activeModule=e,Q(),Tu()}function Bl(){Z.activeModule=null,Q(),Tu()}function Vl(e){return e?`<div class="sheet"><div class="sheet-title"><h3>✦ Ringkasan AI</h3><span class="pill">${Il(e.type)}</span></div><div class="module-card" style="box-shadow:none;min-height:70px;margin-bottom:10px">${Fl(e.type)}<div><h3 class="module-title">${$(e.title)}</h3><p class="small muted" style="margin:0">${$(e.meta)}</p></div></div><div class="sheet-block"><h4>Ringkasan</h4><div class="summary-card">${$(e.summary)}</div></div><div class="sheet-block"><h4>Poin Penting</h4><div class="summary-card"><ul style="padding-left:18px;margin:0">${e.points.map(e=>`<li>${$(e)}</li>`).join(``)}</ul></div></div><div class="sheet-block"><h4>Tips Belajar</h4><div class="summary-card"><ul style="padding-left:18px;margin:0">${e.tips.map(e=>`<li>${$(e)}</li>`).join(``)}</ul></div></div><div class="sheet-block"><h4>AI Insight</h4><div class="insight-card"><div class="insight-row"><span>▣ Tingkat Kesulitan</span><span class="tag">${$(e.difficulty)}</span></div><div class="insight-row"><span>◉ Estimasi Waktu</span><span class="tag">${$(e.time)}</span></div></div></div><div class="actions-row" style="margin-top:12px"><button class="btn" onclick="window.closeModule()">Tutup</button></div></div>`:``}function Hl(){Z.currentSetIndex=0,Z.currentTier=1,Z.quizResults=[],Z.selectedOption=null,Z.confidence=null,Z.quizTimeLeft=600,Z.quizTimerActive=!0,Q(),Ul(),ll(`studentQuizPage`)}function Ul(){clearInterval(al),al=setInterval(()=>{if(Z.quizTimeLeft<=0){Xl();return}Z.quizTimeLeft--;let e=document.getElementById(`quizTimer`);if(e){let t=Math.floor(Z.quizTimeLeft/60),n=Z.quizTimeLeft%60;e.textContent=`⏱ ${String(t).padStart(2,`0`)} : ${String(n).padStart(2,`0`)}`}},1e3)}function Wl(){if(!Z.quizTimerActive&&Z.quizResults.length===0){xl(`${yl()}<h1 class="page-title">Kuis Adaptif 4-Tier</h1><p class="page-subtitle">Uji pemahamanmu tentang kesetimbangan kimia secara berlapis!</p><div class="glass-card hero-topic" style="min-height:180px"><span class="label">Kesetimbangan Kimia</span><h2>10 Set Soal • Evaluasi Diagnostik</h2><button class="hero-action" onclick="window.startQuiz()">Mulai Kuis</button></div>`);return}}function Gl(){let e=Xc[Z.currentSetIndex];if(!e)return Xl();let t=Z.currentTier,n=Z.currentSetIndex*4+t,r=Math.round(n/40*100),i=Math.floor(Z.quizTimeLeft/60),a=Z.quizTimeLeft%60,o=[1,2,3,4].map(e=>e<t?`done`:e===t?`active`:``),s=``;if(t===1||t===3){let n=t===1?e.tier1:e.tier3;s=`<div class="quiz-card"><h3>${t===1?`Tier 1 — Jawaban Konsep`:`Tier 3 — Alasan Ilmiah`}: ${$(n.question)}</h3><div class="option-list">${n.options.map((e,t)=>`<button class="option ${Z.selectedOption===t?`selected`:``}" onclick="window.selectOption(${t})"><b>${String.fromCharCode(65+t)}.</b><span>${$(e)}</span></button>`).join(``)}</div></div>`}else s=`<div class="confidence-card"><h4>Seberapa yakin dengan argumentasi Anda?</h4><div class="conf-grid">${[`Tidak Yakin`,`Yakin`,`Sangat Yakin`].map(e=>`<button class="conf-btn ${Z.confidence===e?`active`:``}" onclick="window.selectConfidence('${e}')">${e}</button>`).join(``)}</div></div>`;xl(`${yl()}<div class="quiz-head"><div><h1 class="page-title">Kuis Adaptif</h1></div><span class="timer" id="quizTimer">⏱ ${String(i).padStart(2,`0`)} : ${String(a).padStart(2,`0`)}</span></div><div class="quiz-progress"><div class="fill" style="--w:${r}%"></div></div><div class="tier-tabs">${[1,2,3,4].map((e,t)=>`<button class="tier ${o[t]}">Tier ${e}</button>`).join(``)}</div>${s}<button class="btn full" style="margin-top:16px" onclick="window.saveAndNext()">Simpan & Lanjut</button>`)}function Kl(e){Z.selectedOption=e,Q(),Tu()}function ql(e){Z.confidence=e,Q(),Tu()}function Jl(){let e=Z.currentTier,t=Z.currentSetIndex,n=Xc[t];if(!n)return Xl();if(e===1||e===3){if(Z.selectedOption===null)return sl(`Pilih opsi jawaban dulu!`)}else if(!Z.confidence)return sl(`Pilih tingkat keyakinan dulu!`);let r=Z.quizResults.find(e=>e.topic===n.topic);if(r||(r={topic:n.topic,setIndex:t},Z.quizResults.push(r)),e===1)r.tier1Answer=Z.selectedOption,r.tier1Correct=Z.selectedOption===n.tier1.answer;else if(e===2)r.tier2Confidence=Z.confidence;else if(e===3)r.tier3Answer=Z.selectedOption,r.tier3Correct=Z.selectedOption===n.tier3.answer;else if(e===4){r.tier4Confidence=Z.confidence;let e=e=>e===`Yakin`||e===`Sangat Yakin`;r.tier1Correct&&e(r.tier2Confidence)&&r.tier3Correct&&e(r.tier4Confidence)?r.category=`Paham Konsep`:r.tier1Correct&&!e(r.tier2Confidence)?r.category=`Menebak`:!r.tier1Correct&&e(r.tier2Confidence)&&!r.tier3Correct&&e(r.tier4Confidence)?r.category=`Miskonsepsi`:r.category=`Tidak Paham`}if(Z.selectedOption=null,Z.confidence=null,e<4)Z.currentTier=e+1,Q(),Tu();else if(r.category===`Miskonsepsi`){Q();let e=n.topic===`Pengaruh Tekanan dan Volume`?`misi2`:`misi1`;_l(`🚨 Diagnosis AI: Deteksi Miskonsepsi!`,`<p style="font-size:13px; line-height:1.5;">Sistem mendeteksi kamu mengalami <b>Miskonsepsi Sejati</b> pada topik ${$(n.topic)}.</p>`,`<button class="btn full" onclick="window.closeModal(); state.webarMisiAktif='${e}'; window.saveState(); window.go('studentWebAR');">📱 Pergi ke Lab WebAR</button>
         <button class="btn ghost full" onclick="window.closeModal(); window.jalankanLompatanAdaptif('${n.topic}', false);">Lewati & Lanjut</button>`)}else Yl(n.topic,!0)}function Yl(e,t){let n=el[e];if(!n)return Xl();let r=t?n.nextOnSuccess:n.nextOnFail;if(r===`END`)Xl();else{let e=Xc.findIndex(e=>e.topic===r);e>=0?(Z.currentSetIndex=e,Z.currentTier=1,Q(),Tu()):Xl()}}function Xl(){clearInterval(al),al=null,Z.quizTimerActive=!1,Q(),ll(`studentResult`)}function Zl(){clearInterval(al),al=null,Z.currentSetIndex=0,Z.currentTier=1,Z.quizResults=[],Q(),ll(`studentQuiz`)}function Ql(e){return e.filter(e=>e.category===`Miskonsepsi`).map(e=>e.topic).length>0?{title:`✦ Hasil Evaluasi Gemini AI`,text:`Sistem mendeteksi struktur Miskonsepsi Sejati pada ingatan kognitif Anda.`,actionText:`Sembuhkan Miskonsepsi via AR`}:{title:`✦ Hasil Evaluasi Gemini AI`,text:`Pemahaman konsep kesetimbangan kimia Anda sudah sangat kokoh dan bebas miskonsepsi.`,actionText:`Eksplorasi Lab AR`}}function $l(){let e=Z.quizResults,t=e.length,n=e.filter(e=>e.tier1Correct).length,r=t?Math.round(n/t*100):0,i=2*Math.PI*45,a=i-r/100*i,o=Ql(e);xl(`${yl({back:!0})}<h1 class="page-title">Hasil Kuis 4-Tier</h1><div class="glass-card" style="border-radius:26px; text-align:center; margin-bottom:14px; padding: 15px;"><div class="score-circle-wrap" style="position:relative; width:100px; height:100px; margin:0 auto 10px;"><svg viewBox="0 0 100 100" style="transform: rotate(-90deg); width:100%; height:100%;"><circle cx="50" cy="50" r="45" fill="none" stroke="#eee" stroke-width="8"/><circle cx="50" cy="50" r="45" fill="none" stroke="var(--purple)" stroke-width="8" stroke-dasharray="${i}" stroke-dashoffset="${a}"/></svg><div style="position:absolute; top:50%; left:50%; transform:translate(-50%,-50%); font-size:22px; font-weight:bold;">${r}%</div></div></div><div style="background:#1e1b4b; padding: 16px; border-radius: 20px; color: white; margin-bottom: 14px;"><h4 style="margin:0 0 6px; color: #00E5FF;">${o.title}</h4><p style="font-size:12px; opacity:0.9;">${o.text}</p><button class="btn full" style="margin-top:10px;" onclick="window.go('studentWebAR')">${o.actionText}</button></div><div class="actions-row"><button class="btn" onclick="window.resetQuiz()">Ulangi Kuis</button></div>`)}function eu(){Z.webarMisiAktif?(nl.innerHTML=``,Wc(nl,Z.webarMisiAktif,()=>{Z.webarMisiAktif=null,Q(),ll(`studentDashboard`)})):(xl(`${yl()}`,{noNav:!0}),Uc(nl.querySelector(`.screen`),e=>{Z.webarMisiAktif=e,Q(),Tu()}))}function tu(){Z.colorblind=!Z.colorblind,Q(),Tu()}function nu(){xl(`
    ...
    <div style="padding:0 28px; margin-top:20px;"><button class="btn ghost full" onclick="window.showAddClassModal()">+ Buat Kelas Baru</button></div>`,{noNav:!0}),setTimeout(iu,60)}var ru=0;function iu(){ru=Z.selectedClassIndex||0,au()}function au(){let e=document.getElementById(`coverflowTrack`);if(!e)return;let t=e.querySelectorAll(`.coverflow-slide`),n=t.length;t.forEach((e,t)=>{let r=t-ru;n>2&&(r>Math.floor(n/2)&&(r-=n),r<-Math.floor(n/2)&&(r+=n));let i=Math.abs(r),a=Math.sign(r),o=i===0?1.05:.85,s=i===0?0:a*140;e.style.transform=`translateX(${s}px) scale(${o})`,e.style.zIndex=i===0?100:50,e.style.opacity=i===0?1:.4,e.style.pointerEvents=i===0?`auto`:`none`})}function ou(e){let t=Z.classes.length;t!==0&&(ru=(ru+e+t)%t,au())}function su(e,t){Z.selectedClassIndex=e,Q(),ll(`teacherDashboard`)}function cu(){let e=dl();xl(`${yl({coins:!1,back:!0,titleBackPage:`teacherClasses`})}
    ...
    </div>`)}function lu(){_l(`Buat Kelas Baru`,`<div class="field"><label>Nama Kelas Baru</label><input id="newClassName" class="input" placeholder="Contoh: XI IPA 4"></div>`,`<button class="btn full" onclick="window.addClass()">Buat Kelas</button><button class="btn ghost full" onclick="window.closeModal()">Batal</button>`)}function uu(){let e=document.getElementById(`newClassName`).value.trim();if(!e)return sl(`Isi nama kelas!`);let t=`KIM-${Math.floor(140+Math.random()*850)}`;Z.classes.push({id:`c${Date.now()}`,name:e,code:t,students:32,progress:0,quiz:10,roster:[]}),Z.selectedClassIndex=Z.classes.length-1,Q(),vl(),Tu(),sl(`Kelas baru ${t} aktif!`)}function du(){let e=dl();xl(`${yl({coins:!1,back:!0,titleBackPage:`teacherDashboard`})}
