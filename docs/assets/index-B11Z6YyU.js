...
void main() {
    ...
    `;let t=document.createElement(`div`);t.style.background=`rgba(40, 40, 40, 0.6)`,t.style.backdropFilter=`blur(12px)`,t.style.borderRadius=`12px`,t.style.padding=`12px 16px`,t.style.color=`#fff`,t.style.width=`240px`,t.innerHTML=`
